...
Future<PhoneConfirmationsRecord> getOrCreatePhoneConfirmation(
  String sender,
  String receiver,
  String senderName,
  String receiverName,
  ...
  DocumentReference docRef = firestore.doc("/PhoneConfirmations/$documentId");

  try {
    final docSnapshot = await docRef.get();
    if (docSnapshot.exists) {
      return PhoneConfirmationsRecord.getDocumentOnce(docRef);
    }
  } catch (e) {
