...
Future<WorkPlacesRecord?> getWorkPlaceDocument(String docId) async {
  final DocumentReference ref =
      FirebaseFirestore.instance.doc('workPlaces/$docId');
  ...
  return WorkPlacesRecord.fromSnapshot(snap);
}
