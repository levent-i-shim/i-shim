...
Future<List<WorkplaceConfirmationsRecord>> getWorkPlaceConfirmation(
  ...
  try {
    ...
    final senderQuery = await firestore
        .collection('workplaceConfirmations')
    ...
    List<WorkplaceConfirmationsRecord> list = [];
    ...
    combinedDocs.sort((a, b) {
      ...
      if (aTime is Timestamp && bTime is Timestamp) {
        list.add(WorkplaceConfirmationsRecord.fromSnapshot(a));
    ...
    list = combinedDocs
        .map((doc) => WorkplaceConfirmationsRecord.fromSnapshot(doc))
        .toList();
