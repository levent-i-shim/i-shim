...
Future<void> safelyMarkMessagesReadAndUpdateCountPersonal(
  DocumentReference authUser,
  DocumentReference personalConfirmations,
) async {
  print('safelyMarkMessagesReadAndUpdateCountPersonal called ');
  final firestore = FirebaseFirestore.instance;

  final querySnapshot = await personalConfirmations
      .collection('PersonalConfirmationsMessages')
