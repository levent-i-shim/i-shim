...
Future<void> safelyMarkMessagesReadAndUpdateCountPhoneConfirmation(
    DocumentReference authUser, DocumentReference PhoneConfirmationsRef) async {
  print('safelyMarkMessagesReadAndUpdateCountPhoneConfirmation called');
  final firestore = FirebaseFirestore.instance;

  final querySnapshot =
      await PhoneConfirmationsRef.collection('PhoneConfirmationMessages')
