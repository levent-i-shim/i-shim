...
Future<void> safelyMarkMessagesReadAndUpdateCount(
  DocumentReference authUser,
  DocumentReference workPlaceConfirmationsRef,
) async {
  print('safelyMarkMessagesReadAndUpdateCount called 2');
  final firestore = FirebaseFirestore.instance;

  final querySnapshot = await workPlaceConfirmationsRef
      .collection('workplaceConfirmationMessage')
