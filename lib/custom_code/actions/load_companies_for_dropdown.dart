...
Future<List<DocumentReference>?> loadCompaniesForDropdown(
  ...
  // Alan adları (sabit)
  const fieldCreator = 'companiesIAmCreator';
  const fieldPartner = 'companiesIAmPartner';
  const fieldAuthorized = 'companiesIAmAuthorizedForWorkers';
