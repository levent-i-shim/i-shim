...
import 'create_financial_plan_model.dart';
export 'create_financial_plan_model.dart';

class CreateFinancialPlanWidget extends StatefulWidget {
  const CreateFinancialPlanWidget({super.key});

  static String routeName = 'createFinancialPlan';
  static String routePath = '/createFinancialPlan';

  @override
  State<CreateFinancialPlanWidget> createState() =>
      _CreateFinancialPlanWidgetState();
}

class _CreateFinancialPlanWidgetState extends State<CreateFinancialPlanWidget> {
  late CreateFinancialPlanModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateFinancialPlanModel());
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      ...
                      if (_model.ownerOrWorkerValue == 'ownerOrPartner') {
                        ...
                        await FinancialPlansRecord.collection
                            .doc()
                            .set(createFinancialPlansRecordData(
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text(
                              'Finansal plan başarı ile oluşturuldu ...',
                              style: TextStyle(
