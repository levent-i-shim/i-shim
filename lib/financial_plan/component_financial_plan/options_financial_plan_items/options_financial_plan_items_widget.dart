...
class OptionsFinancialPlanItemsWidget extends StatefulWidget {
  const OptionsFinancialPlanItemsWidget({
    super.key,
  ...
  @override
  State<OptionsFinancialPlanItemsWidget> createState() =>
      _OptionsFinancialPlanItemsWidgetState();
}

class _OptionsFinancialPlanItemsWidgetState
    extends State<OptionsFinancialPlanItemsWidget> {
  late OptionsFinancialPlanItemsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OptionsFinancialPlanItemsModel());
