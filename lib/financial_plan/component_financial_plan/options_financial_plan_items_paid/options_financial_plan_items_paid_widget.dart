...
class OptionsFinancialPlanItemsPaidWidget extends StatefulWidget {
  const OptionsFinancialPlanItemsPaidWidget({
    super.key,
  ...
  @override
  State<OptionsFinancialPlanItemsPaidWidget> createState() =>
      _OptionsFinancialPlanItemsPaidWidgetState();
}

class _OptionsFinancialPlanItemsPaidWidgetState
    extends State<OptionsFinancialPlanItemsPaidWidget> {
  late OptionsFinancialPlanItemsPaidModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OptionsFinancialPlanItemsPaidModel());
                  ...
                  await showDialog(
                    ...
                    builder: (alertDialogContext) {
                      return AlertDialog(
                        ...
                        content: Text('Ödenmedi olarak işlendi.'),
                        actions: [
                          TextButton(
