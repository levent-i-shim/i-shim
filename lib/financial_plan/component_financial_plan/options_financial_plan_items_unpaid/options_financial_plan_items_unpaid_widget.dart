...
class OptionsFinancialPlanItemsUnpaidWidget extends StatefulWidget {
  const OptionsFinancialPlanItemsUnpaidWidget({
    super.key,
  ...
  @override
  State<OptionsFinancialPlanItemsUnpaidWidget> createState() =>
      _OptionsFinancialPlanItemsUnpaidWidgetState();
}

class _OptionsFinancialPlanItemsUnpaidWidgetState
    extends State<OptionsFinancialPlanItemsUnpaidWidget> {
  late OptionsFinancialPlanItemsUnpaidModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OptionsFinancialPlanItemsUnpaidModel());
                ...
                onTap: () async {
                  ...
                  await showDialog(
                    ...
                    builder: (alertDialogContext) {
                      return AlertDialog(
                        title: Text('Ödenme Durumu'),
                        content: Text('Erteleneceklere eklendi.'),
                        actions: [
                          TextButton(
                            onPressed: () => Navigator.pop(alertDialogContext),
                            child: Text('Tamam'),
