...
class ResponseFormForDutyWidget extends StatefulWidget {
  const ResponseFormForDutyWidget({
    super.key,
  ...
  static String routeName = 'ResponseFormForDuty';
  static String routePath = '/responseFormForDuty';

  @override
  State<ResponseFormForDutyWidget> createState() =>
      _ResponseFormForDutyWidgetState();
}

class _ResponseFormForDutyWidgetState extends State<ResponseFormForDutyWidget> {
  late ResponseFormForDutyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ResponseFormForDutyModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<FormFieldsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<FormFieldsRecord> responseFormForDutyFormFieldsRecordList =
            snapshot.data!;
                                ...
                                child: Builder(
                                  builder: (context) {
                                    ...
                                    return ListView.builder(
                                      ...
                                      itemBuilder: (context, reportsIndex) {
                                        final reportsItem =
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Flexible(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            builder:
                                                                                (context) {
                                                                              if (containerFormResponsesRecord.fieldValueType == FieldValueType.Image.name) {
                                                                                return Padding(
