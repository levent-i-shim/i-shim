...
class UpdateNoteFinancePersonalPageWidget extends StatefulWidget {
  const UpdateNoteFinancePersonalPageWidget({
    super.key,
    required this.isEdit,
    this.noteFinancePersonal,
  });

  final bool? isEdit;
  final FinancialMonitoringNotesRecord? noteFinancePersonal;

  static String routeName = 'UpdateNoteFinancePersonalPage';
  static String routePath = '/updateNoteFinancePersonalPage';

  @override
  State<UpdateNoteFinancePersonalPageWidget> createState() =>
      _UpdateNoteFinancePersonalPageWidgetState();
}

class _UpdateNoteFinancePersonalPageWidgetState
    extends State<UpdateNoteFinancePersonalPageWidget> {
  late UpdateNoteFinancePersonalPageModel _model;
