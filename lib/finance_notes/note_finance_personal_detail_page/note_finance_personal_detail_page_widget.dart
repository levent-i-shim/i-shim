...
class NoteFinancePersonalDetailPageWidget extends StatefulWidget {
  const NoteFinancePersonalDetailPageWidget({
    super.key,
  ...
  static String routeName = 'noteFinancePersonalDetailPage';
  static String routePath = '/noteFinancePersonalDetailPage';

  @override
  State<NoteFinancePersonalDetailPageWidget> createState() =>
      _NoteFinancePersonalDetailPageWidgetState();
}

class _NoteFinancePersonalDetailPageWidgetState
    extends State<NoteFinancePersonalDetailPageWidget> {
  late NoteFinancePersonalDetailPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NoteFinancePersonalDetailPageModel());
            ...
            Align(
              ...
              child: Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    context.pushNamed(
                      UpdateNoteFinancePersonalPageWidget.routeName,
                      queryParameters: {
