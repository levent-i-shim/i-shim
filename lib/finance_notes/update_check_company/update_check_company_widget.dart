...
class UpdateCheckCompanyWidget extends StatefulWidget {
  const UpdateCheckCompanyWidget({
    super.key,
  ...
  final bool? isEdit;
  final FinancialNoteCompanyCheckRecord? companyPaymentDoc;

  static String routeName = 'updateCheckCompany';
  static String routePath = '/updateCheckCompany';

  @override
  State<UpdateCheckCompanyWidget> createState() =>
      _UpdateCheckCompanyWidgetState();
}

class _UpdateCheckCompanyWidgetState extends State<UpdateCheckCompanyWidget> {
  late UpdateCheckCompanyModel _model;
