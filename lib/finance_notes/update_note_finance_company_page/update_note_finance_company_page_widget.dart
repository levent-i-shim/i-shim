...
import 'update_note_finance_company_page_model.dart';
export 'update_note_finance_company_page_model.dart';

class UpdateNoteFinanceCompanyPageWidget extends StatefulWidget {
  const UpdateNoteFinanceCompanyPageWidget({
    super.key,
  ...
  static String routeName = 'UpdateNoteFinanceCompanyPage';
  static String routePath = '/updateNoteFinanceCompanyPage';

  @override
  State<UpdateNoteFinanceCompanyPageWidget> createState() =>
      _UpdateNoteFinanceCompanyPageWidgetState();
}

class _UpdateNoteFinanceCompanyPageWidgetState
    extends State<UpdateNoteFinanceCompanyPageWidget> {
  late UpdateNoteFinanceCompanyPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdateNoteFinanceCompanyPageModel());
