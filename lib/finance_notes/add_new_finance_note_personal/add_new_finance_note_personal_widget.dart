...
import 'add_new_finance_note_personal_model.dart';
export 'add_new_finance_note_personal_model.dart';

class AddNewFinanceNotePersonalWidget extends StatefulWidget {
  const AddNewFinanceNotePersonalWidget({
    super.key,
  ...
  static String routeName = 'AddNewFinanceNotePersonal';
  static String routePath = '/AddNewFinanceNotePersonal';

  @override
  State<AddNewFinanceNotePersonalWidget> createState() =>
      _AddNewFinanceNotePersonalWidgetState();
}

class _AddNewFinanceNotePersonalWidgetState
    extends State<AddNewFinanceNotePersonalWidget> {
  late AddNewFinanceNotePersonalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddNewFinanceNotePersonalModel());
                        ...
                        onPressed: () async {
                          ...
                          if (_model.validate!) {
                            if (widget.isEdit!) {
                              ...
                              {
                                safeSetState(() => _model
                                        .isDataUploading_uploadPersonalPDFToFirebase =
                                    true);
                                ...
                                try {
                                  selectedUploadedFiles = _model
                                          .uploadedLocalFile_personalUploadPDF
                                          .bytes!
                                          .isNotEmpty
                                      ? [
                                          _model
                                  ...
                                  _model.isDataUploading_uploadPersonalPDFToFirebase =
                                      false;
                                }
                                if (selectedUploadedFiles.length ==
                                    ...
                                    downloadUrls.length ==
                                        selectedFiles.length) {
                                  safeSetState(() {
                                    _model.uploadedLocalFile_uploadPersonalPDFToFirebase =
                                        selectedUploadedFiles.first;
                                    _model.uploadedFileUrl_uploadPersonalPDFToFirebase =
                                        downloadUrls.first;
                                  });
                                } else {
                                  safeSetState(() {});
                        ...
                        onPressed: () async {
                          ...
                          if (_model.validate2!) {
                            if (widget.isEdit!) {
                              ...
                              {
                                safeSetState(() => _model
                                        .isDataUploading_uploadePersonalMediaToFirebase =
                                    true);
                                var selectedUploadedFiles = <FFUploadedFile>[];
                                ...
                                try {
                                  selectedUploadedFiles = _model
                                          .uploadedLocalFile_personalUploadeMedia
                                          .bytes!
                                          .isNotEmpty
                                      ? [
                                          _model
                                  ...
                                  _model.isDataUploading_uploadePersonalMediaToFirebase =
                                      false;
                                }
                                if (selectedUploadedFiles.length ==
                                    ...
                                    downloadUrls.length ==
                                        selectedMedia.length) {
                                  safeSetState(() {
                                    _model.uploadedLocalFile_uploadePersonalMediaToFirebase =
                                        selectedUploadedFiles.first;
                                    _model.uploadedFileUrl_uploadePersonalMediaToFirebase =
                                        downloadUrls.first;
                                  });
                                } else {
                                  safeSetState(() {});
                              ...
                              await financialMonitoringNotesRecordReference
                                ...
                                ...createFinancialMonitoringNotesRecordData(
                                  ...
                                  incomeOrExpense: _model.dropDownValue?.name,
                                  imagePath: _model
                                      .uploadedFileUrl_uploadePersonalMediaToFirebase,
                                  doesHaveBill: false,
                                  personalName: currentUserDisplayName,
                                ),
                                ...mapToFirestore(
                      ...
                      child: StreamBuilder<List<CompaniesRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          return FlutterFlowDropDown<String>(
                            ...
                            hintText: 'Adına harcama yapacağın kişi ?',
                            icon: Icon(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            ...
                                            if (selectedFiles != null) {
                                              safeSetState(() => _model
                                                      .isDataUploading_personalUploadPDF =
                                                  true);
                                              ...
                                              try {
                                                ...
                                                ScaffoldMessenger.of(context)
                                                    .hideCurrentSnackBar();
                                                _model.isDataUploading_personalUploadPDF =
                                                    false;
                                              }
                                              if (selectedUploadedFiles
                                                  ...
                                                  selectedFiles.length) {
                                                safeSetState(() {
                                                  _model.uploadedLocalFile_personalUploadPDF =
                                                      selectedUploadedFiles
                                                          .first;
                                                });
                                                showUploadMessage(
                                            ...
                                            if (selectedMedia != null &&
                                                selectedMedia.every((m) =>
                                                    validateFileFormat(
                                                        ...
                                                        context))) {
                                              safeSetState(() => _model
                                                      .isDataUploading_personalUploadeMedia =
                                                  true);
                                              var selectedUploadedFiles =
                                                  <FFUploadedFile>[];
                                              ...
                                              try {
                                                ...
                                                ScaffoldMessenger.of(context)
                                                    .hideCurrentSnackBar();
                                                _model.isDataUploading_personalUploadeMedia =
                                                    false;
                                              }
                                              if (selectedUploadedFiles
                                                      .length ==
                                                  selectedMedia.length) {
                                                safeSetState(() {
                                                  _model.uploadedLocalFile_personalUploadeMedia =
                                                      selectedUploadedFiles
                                                          .first;
                                                });
                                                showUploadMessage(
                                          ...
                                          child: Container(
                                            ...
                                            child: Stack(
                                              ...
                                              children: [
                                                ...
                                                if ((_model.uploadedLocalFile_personalUploadeMedia
                                                            .bytes?.isNotEmpty ??
                                                        false))
                                                  Align(
                                                    alignment:
