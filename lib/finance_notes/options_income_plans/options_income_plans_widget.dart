...
class OptionsIncomePlansWidget extends StatefulWidget {
  const OptionsIncomePlansWidget({
    super.key,
  ...
  @override
  State<OptionsIncomePlansWidget> createState() =>
      _OptionsIncomePlansWidgetState();
}

class _OptionsIncomePlansWidgetState extends State<OptionsIncomePlansWidget> {
  late OptionsIncomePlansModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OptionsIncomePlansModel());
