...
class NoteFinanceDetailPageWidget extends StatefulWidget {
  const NoteFinanceDetailPageWidget({
    super.key,
    required this.noteFinance,
  });

  final FinancialMonitoringNotesRecord? noteFinance;

  static String routeName = 'noteFinanceDetailPage';
  static String routePath = '/noteFinaceDetailPage';

  @override
  State<NoteFinanceDetailPageWidget> createState() =>
      _NoteFinanceDetailPageWidgetState();
}

class _NoteFinanceDetailPageWidgetState
    extends State<NoteFinanceDetailPageWidget> {
  late NoteFinanceDetailPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NoteFinanceDetailPageModel());
