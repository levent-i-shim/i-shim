...
class CheckDetailWidget extends StatefulWidget {
  const CheckDetailWidget({
    super.key,
    required this.paymentDocument,
  });

  final FinancialNoteCompanyCheckRecord? paymentDocument;

  static String routeName = 'checkDetail';
  static String routePath = '/checkDetail';

  @override
  State<CheckDetailWidget> createState() => _CheckDetailWidgetState();
}

class _CheckDetailWidgetState extends State<CheckDetailWidget> {
  late CheckDetailModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CheckDetailModel());
