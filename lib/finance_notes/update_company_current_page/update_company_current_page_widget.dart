...
class UpdateCompanyCurrentPageWidget extends StatefulWidget {
  const UpdateCompanyCurrentPageWidget({
    super.key,
    required this.isEdit,
    required this.companyCurrentDocumentRef,
  });

  final bool? isEdit;
  final CompaniesCurrentsRecord? companyCurrentDocumentRef;

  static String routeName = 'updateCompanyCurrentPage';
  static String routePath = '/updateCompanyCurrentPage';

  @override
  State<UpdateCompanyCurrentPageWidget> createState() =>
      _UpdateCompanyCurrentPageWidgetState();
}

class _UpdateCompanyCurrentPageWidgetState
    extends State<UpdateCompanyCurrentPageWidget> {
  late UpdateCompanyCurrentPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdateCompanyCurrentPageModel());
