...
import 'create_investment_plan_model.dart';
export 'create_investment_plan_model.dart';

class CreateInvestmentPlanWidget extends StatefulWidget {
  const CreateInvestmentPlanWidget({super.key});

  static String routeName = 'createInvestmentPlan';
  static String routePath = '/createInvestmentPlan';

  @override
  State<CreateInvestmentPlanWidget> createState() =>
      _CreateInvestmentPlanWidgetState();
}

class _CreateInvestmentPlanWidgetState
    extends State<CreateInvestmentPlanWidget> {
  late CreateInvestmentPlanModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateInvestmentPlanModel());
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      ...
                      if (_model.ownerOrWorkerValue == 'ownerOrPartner') {
                        ...
                        await InvestmentPlansRecord.collection
                            .doc()
                            .set(createInvestmentPlansRecordData(
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text(
                              'Yatırım planı başarı ile oluşturuldu ...',
                              style: TextStyle(
