...
class AddNewNoteImportantPageWidget extends StatefulWidget {
  const AddNewNoteImportantPageWidget({
    super.key,
  ...
  final bool? isEdit;
  final ImportantNotesRecord? noteImportant;

  static String routeName = 'AddNewNoteImportantPage';
  static String routePath = '/addNewNoteImportantPage';

  @override
  State<AddNewNoteImportantPageWidget> createState() =>
      _AddNewNoteImportantPageWidgetState();
}

class _AddNewNoteImportantPageWidgetState
    extends State<AddNewNoteImportantPageWidget> {
  late AddNewNoteImportantPageModel _model;
                  ...
                  onPressed: () async {
                    ...
                    if (_model.validate!) {
                      if (widget.isEdit!) {
                        ...
                        var importantNotesRecordReference =
                            ImportantNotesRecord.createDoc(
                                currentUserReference!);
                        await importantNotesRecordReference.set({
                          ...createImportantNotesRecordData(
                            title: _model.textFieldTitleTextController.text,
                            content: _model.textFieldContentTextController.text,
                            isDeleted: false,
                          ),
                        ...
                        _model.addedNote =
                            ImportantNotesRecord.getDocumentFromData({
                          ...createImportantNotesRecordData(
                            title: _model.textFieldTitleTextController.text,
                            content: _model.textFieldContentTextController.text,
                            isDeleted: false,
