...
class UpdateNoteDiaryPageWidget extends StatefulWidget {
  const UpdateNoteDiaryPageWidget({
    super.key,
  ...
  static String routeName = 'UpdateNoteDiaryPage';
  static String routePath = '/updateNoteDiaryPage';

  @override
  State<UpdateNoteDiaryPageWidget> createState() =>
      _UpdateNoteDiaryPageWidgetState();
}

class _UpdateNoteDiaryPageWidgetState extends State<UpdateNoteDiaryPageWidget> {
  late UpdateNoteDiaryPageModel _model;
