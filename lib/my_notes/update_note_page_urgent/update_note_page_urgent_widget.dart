...
class UpdateNotePageUrgentWidget extends StatefulWidget {
  const UpdateNotePageUrgentWidget({
    super.key,
  ...
  static String routeName = 'UpdateNotePageUrgent';
  static String routePath = '/updateNotePageUrgent';

  @override
  State<UpdateNotePageUrgentWidget> createState() =>
      _UpdateNotePageUrgentWidgetState();
}

class _UpdateNotePageUrgentWidgetState
    extends State<UpdateNotePageUrgentWidget> {
  late UpdateNotePageUrgentModel _model;
