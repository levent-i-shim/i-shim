...
class UpdateNoteGoalPageWidget extends StatefulWidget {
  const UpdateNoteGoalPageWidget({
    super.key,
  ...
  static String routeName = 'UpdateNoteGoalPage';
  static String routePath = '/updateNoteGoalPage';

  @override
  State<UpdateNoteGoalPageWidget> createState() =>
      _UpdateNoteGoalPageWidgetState();
}

class _UpdateNoteGoalPageWidgetState extends State<UpdateNoteGoalPageWidget> {
  late UpdateNoteGoalPageModel _model;
