...
class AddNewNotePageUrgentWidget extends StatefulWidget {
  const AddNewNotePageUrgentWidget({
    super.key,
  ...
  final bool? isEdit;
  final UrgentNotesRecord? urgentNote;

  static String routeName = 'AddNewNotePageUrgent';
  static String routePath = '/addNewNotePageUrgent';

  @override
  State<AddNewNotePageUrgentWidget> createState() =>
      _AddNewNotePageUrgentWidgetState();
}

class _AddNewNotePageUrgentWidgetState
    extends State<AddNewNotePageUrgentWidget> {
  late AddNewNotePageUrgentModel _model;
                  ...
                  onPressed: () async {
                    ...
                    if (_model.validate!) {
                      if (widget!.isEdit!) {
                        ...
                        var urgentNotesRecordReference =
                            UrgentNotesRecord.createDoc(currentUserReference!);
                        await urgentNotesRecordReference
                            .set(createUrgentNotesRecordData(
                          title: _model.textFieldTitleTextController.text,
                          content: _model.textFieldContentTextController.text,
                        ...
                        _model.addedNote =
                            UrgentNotesRecord.getDocumentFromData(
                                createUrgentNotesRecordData(
                                  title:
