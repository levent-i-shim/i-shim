...
class UpdateNotePageWidget extends StatefulWidget {
  const UpdateNotePageWidget({
    super.key,
  ...
  static String routeName = 'UpdateNotePage';
  static String routePath = '/updateNotePage';

  @override
  State<UpdateNotePageWidget> createState() => _UpdateNotePageWidgetState();
}

class _UpdateNotePageWidgetState extends State<UpdateNotePageWidget> {
  late UpdateNotePageModel _model;
