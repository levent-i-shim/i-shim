...
class NoteDiaryDetailPageWidget extends StatefulWidget {
  const NoteDiaryDetailPageWidget({
    super.key,
    required this.noteDiary,
  });

  final PersonalDiaryRecord? noteDiary;

  static String routeName = 'NoteDiaryDetailPage';
  static String routePath = '/noteDiaryDetailPage';

  @override
  State<NoteDiaryDetailPageWidget> createState() =>
      _NoteDiaryDetailPageWidgetState();
}

class _NoteDiaryDetailPageWidgetState extends State<NoteDiaryDetailPageWidget> {
  late NoteDiaryDetailPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NoteDiaryDetailPageModel());
            ...
            Align(
              ...
              child: Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    context.pushNamed(
                      UpdateNoteDiaryPageWidget.routeName,
                      queryParameters: {
