...
class NoteGoalDetailPageWidget extends StatefulWidget {
  const NoteGoalDetailPageWidget({
    super.key,
  ...
  static String routeName = 'NoteGoalDetailPage';
  static String routePath = '/noteGoalDetailPage';

  @override
  State<NoteGoalDetailPageWidget> createState() =>
      _NoteGoalDetailPageWidgetState();
}

class _NoteGoalDetailPageWidgetState extends State<NoteGoalDetailPageWidget> {
  late NoteGoalDetailPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NoteGoalDetailPageModel());
