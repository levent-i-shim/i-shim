...
class NoteImportantDetailPageWidget extends StatefulWidget {
  const NoteImportantDetailPageWidget({
    super.key,
    required this.noteImportant,
  });

  final ImportantNotesRecord? noteImportant;

  static String routeName = 'NoteImportantDetailPage';
  static String routePath = '/noteImportantDetailPage';

  @override
  State<NoteImportantDetailPageWidget> createState() =>
      _NoteImportantDetailPageWidgetState();
}

class _NoteImportantDetailPageWidgetState
    extends State<NoteImportantDetailPageWidget> {
  late NoteImportantDetailPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NoteImportantDetailPageModel());
            ...
            Align(
              ...
              child: Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    context.pushNamed(
                      UpdateNoteImportantPageWidget.routeName,
                      queryParameters: {
