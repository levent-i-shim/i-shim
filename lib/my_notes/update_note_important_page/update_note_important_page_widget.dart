...
class UpdateNoteImportantPageWidget extends StatefulWidget {
  const UpdateNoteImportantPageWidget({
    super.key,
  ...
  static String routeName = 'UpdateNoteImportantPage';
  static String routePath = '/updateNoteImportantPage';

  @override
  State<UpdateNoteImportantPageWidget> createState() =>
      _UpdateNoteImportantPageWidgetState();
}

class _UpdateNoteImportantPageWidgetState
    extends State<UpdateNoteImportantPageWidget> {
  late UpdateNoteImportantPageModel _model;
