...
import 'add_new_note_page_model.dart';
export 'add_new_note_page_model.dart';

class AddNewNotePageWidget extends StatefulWidget {
  const AddNewNotePageWidget({
    super.key,
  ...
  static String routeName = 'AddNewNotePage';
  static String routePath = '/addNewNotePage';

  @override
  State<AddNewNotePageWidget> createState() => _AddNewNotePageWidgetState();
}

class _AddNewNotePageWidgetState extends State<AddNewNotePageWidget> {
  late AddNewNotePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddNewNotePageModel());
                  ...
                  onPressed: () async {
                    ...
                    if (_model.validate!) {
                      if (widget!.isEdit!) {
                        ...
                        _model.addedNote = NotesRecord.getDocumentFromData({
                          ...createNotesRecordData(
                            title: _model.textFieldTitleTextController.text,
                            content: _model.textFieldContentTextController.text,
                            isDelete: false,
                        ...
                        await AjandaRecord.createDoc(currentUserReference!)
                          ...
                          ...createAjandaRecordData(
                            ...
                            note: _model.addedNote?.reference,
                          ),
                          ...mapToFirestore(
                            {
