...
import 'add_new_note_goal_page_model.dart';
export 'add_new_note_goal_page_model.dart';

class AddNewNoteGoalPageWidget extends StatefulWidget {
  const AddNewNoteGoalPageWidget({
    super.key,
  ...
  final bool? isEdit;
  final GoalNotesRecord? noteGoal;

  static String routeName = 'AddNewNoteGoalPage';
  static String routePath = '/addNewNoteGoalPage';

  @override
  State<AddNewNoteGoalPageWidget> createState() =>
      _AddNewNoteGoalPageWidgetState();
}

class _AddNewNoteGoalPageWidgetState extends State<AddNewNoteGoalPageWidget> {
  late AddNewNoteGoalPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddNewNoteGoalPageModel());
                  ...
                  onPressed: () async {
                    ...
                    if (_model.validate!) {
                      if (widget.isEdit!) {
                        ...
                        var goalNotesRecordReference =
                            GoalNotesRecord.createDoc(currentUserReference!);
                        await goalNotesRecordReference.set({
                          ...createGoalNotesRecordData(
                            title: _model.textFieldTitleTextController.text,
                            content: _model.textFieldContentTextController.text,
                            isDeleted: false,
                          ),
                        ...
                        _model.addedNote = GoalNotesRecord.getDocumentFromData({
                          ...createGoalNotesRecordData(
                            title: _model.textFieldTitleTextController.text,
                            content: _model.textFieldContentTextController.text,
                            isDeleted: false,
                        ...
                        await AjandaRecord.createDoc(currentUserReference!)
                          ...
                          ...createAjandaRecordData(
                            ...
                            noteGoals: widget.noteGoal?.reference,
                          ),
                          ...mapToFirestore(
                            {
