...
class IncomePlanIAuthorizeSettingsWidget extends StatefulWidget {
  const IncomePlanIAuthorizeSettingsWidget({
    super.key,
  ...
  static String routeName = 'incomePlanIAuthorizeSettings';
  static String routePath = '/incomePlanIAuthorizeSettings';

  @override
  State<IncomePlanIAuthorizeSettingsWidget> createState() =>
      _IncomePlanIAuthorizeSettingsWidgetState();
}

class _IncomePlanIAuthorizeSettingsWidgetState
    extends State<IncomePlanIAuthorizeSettingsWidget>
    with TickerProviderStateMixin {
  late IncomePlanIAuthorizeSettingsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => IncomePlanIAuthorizeSettingsModel());
