...
class AddNewNoteDiaryPageWidget extends StatefulWidget {
  const AddNewNoteDiaryPageWidget({
    super.key,
  ...
  final bool? isEdit;
  final PersonalDiaryRecord? noteDiary;

  static String routeName = 'AddNewNoteDiaryPage';
  static String routePath = '/addNewNoteDiaryPage';

  @override
  State<AddNewNoteDiaryPageWidget> createState() =>
      _AddNewNoteDiaryPageWidgetState();
}

class _AddNewNoteDiaryPageWidgetState extends State<AddNewNoteDiaryPageWidget> {
  late AddNewNoteDiaryPageModel _model;
                  ...
                  onPressed: () async {
                    ...
                    if (_model.validate!) {
                      if (widget!.isEdit!) {
                        ...
                        var personalDiaryRecordReference =
                            PersonalDiaryRecord.createDoc(
                                currentUserReference!);
                        await personalDiaryRecordReference.set({
                          ...createPersonalDiaryRecordData(
                            title: _model.textFieldTitleTextController.text,
                            content: _model.textFieldContentTextController.text,
                            isDeleted: false,
                          ),
                        ...
                        _model.addedNote =
                            PersonalDiaryRecord.getDocumentFromData({
                          ...createPersonalDiaryRecordData(
                            title: _model.textFieldTitleTextController.text,
                            content: _model.textFieldContentTextController.text,
                            isDeleted: false,
