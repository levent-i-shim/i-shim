...
class ShiftRequestPageWidget extends StatefulWidget {
  const ShiftRequestPageWidget({
    super.key,
  ...
  static String routeName = 'ShiftRequestPage';
  static String routePath = '/shiftRequestPage';

  @override
  State<ShiftRequestPageWidget> createState() => _ShiftRequestPageWidgetState();
}

class _ShiftRequestPageWidgetState extends State<ShiftRequestPageWidget> {
  late ShiftRequestPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ShiftRequestPageModel());
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(0.0, 36.0, 0.0, 8.0),
                      child: Container(
                        decoration: BoxDecoration(
                          color: Colors.white,
                    ...
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          ...
                          _model.shiftRequest =
                              WorkerShiftsRecord.getDocumentFromData({
                            ...createWorkerShiftsRecordData(
                              userRef: currentUserReference,
                              hour:
                                  double.tryParse(_model.textController1.text),
                          ...
                          }, workerShiftsRecordReference);

                          await NotificationsRecord.createDoc(
                                  _model.companyDetail!.owner!)
                              .set({
                            ...createNotificationsRecordData(
                              type: NotificationTypes.shiftRequest.name,
                              content: 'Vardiya Talebi',
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
                                'Talebiniz Başarı ile Gönderildi',
                                style: TextStyle(
                                  color:
