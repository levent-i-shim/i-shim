...
import 'income_payment_delete_component_model.dart';
export 'income_payment_delete_component_model.dart';

class IncomePaymentDeleteComponentWidget extends StatefulWidget {
  const IncomePaymentDeleteComponentWidget({
    super.key,
  ...
  @override
  State<IncomePaymentDeleteComponentWidget> createState() =>
      _IncomePaymentDeleteComponentWidgetState();
}

class _IncomePaymentDeleteComponentWidgetState
    extends State<IncomePaymentDeleteComponentWidget> {
  late IncomePaymentDeleteComponentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => IncomePaymentDeleteComponentModel());
                      ...
                      Row(
                        ...
                        children: [
                          Flexible(
                            flex: 9,
                            child: Text(
                              'Bir gelir/gider öğesini silmek üzeresiniz.',
