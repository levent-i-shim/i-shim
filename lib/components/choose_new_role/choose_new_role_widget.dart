...
class ChooseNewRoleWidget extends StatefulWidget {
  const ChooseNewRoleWidget({
    super.key,
  ...
  @override
  State<ChooseNewRoleWidget> createState() => _ChooseNewRoleWidgetState();
}

class _ChooseNewRoleWidgetState extends State<ChooseNewRoleWidget> {
  late ChooseNewRoleModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChooseNewRoleModel());
                ...
                children: [
                      ...
                      Flexible(
                        child: Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              12.0, 8.0, 12.0, 0.0),
                          child: Text(
                            'Bu Roldeki çalışanları topluca başka bir Role atamak ister misiniz',
                  ...
                  Padding(
                    ...
                    child: FlutterFlowDropDown<String>(
                      ...
                      options: List<String>.from(containerCompanyRolesRecordList
                          .map((e) => e.reference.id)
                          .toList()),
                      optionLabels: containerCompanyRolesRecordList
                          .map((e) => e.name)
                          .toList(),
                      onChanged: (val) =>
