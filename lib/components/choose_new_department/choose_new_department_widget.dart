...
class ChooseNewDepartmentWidget extends StatefulWidget {
  const ChooseNewDepartmentWidget({
    super.key,
  ...
  @override
  State<ChooseNewDepartmentWidget> createState() =>
      _ChooseNewDepartmentWidgetState();
}

class _ChooseNewDepartmentWidgetState extends State<ChooseNewDepartmentWidget> {
  late ChooseNewDepartmentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChooseNewDepartmentModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<CompanyDepartmentsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CompanyDepartmentsRecord> containerCompanyDepartmentsRecordList =
            snapshot.data!;
                        ...
                        Flexible(
                          child: Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                12.0, 8.0, 12.0, 0.0),
                            child: Text(
                              'Bu departmandaki çalışanları topluca başka bir departmana atamak ister misiniz',
                    ...
                    Padding(
                      ...
                      child: FlutterFlowDropDown<String>(
                        ...
                        options: List<String>.from(
                            containerCompanyDepartmentsRecordList
                                .map((e) => e.reference.id)
                                .toList()),
                        optionLabels: containerCompanyDepartmentsRecordList
                            .map((e) => e.name)
                            .toList(),
                        onChanged: (val) =>
                                ...
                                if (_model.validateForm!) {
                                  ...
                                  if (_model.newDepartment ==
                                    ...
                                    for (int loop1Index = 0;
                                      ...
                                      _model.isAuthorizedByDepartment =
                                          currentLoop1Item
                                              .hasAuthorizedByDepartment();
                                      if (_model.isAuthorizedByDepartment) {
                                        await currentLoop1Item.reference
                                            .update({
                                          ...mapToFirestore(
                                            {
                                              'departmentRefs':
                                                  _model.newDepartmentList,
