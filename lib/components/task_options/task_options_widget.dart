...
class TaskOptionsWidget extends StatefulWidget {
  ...
  final CompanyTaskDutiesRecord? taskDuties;
  final bool? isTask;

  @override
  State<TaskOptionsWidget> createState() => _TaskOptionsWidgetState();
}

class _TaskOptionsWidgetState extends State<TaskOptionsWidget> {
  late TaskOptionsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TaskOptionsModel());
                ...
                onTap: () async {
                  var confirmDialogResponse = await showDialog<bool>(
                        ...
                        builder: (alertDialogContext) {
                          return AlertDialog(
                            title: Text('Bu Görev Silinecek'),
                            content: Text(
                                'Bu Görevi Silmek İstediğinize Emin misiniz'),
                            actions: [
                              TextButton(
                                onPressed: () =>
