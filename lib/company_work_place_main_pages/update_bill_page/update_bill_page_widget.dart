...
import 'update_bill_page_model.dart';
export 'update_bill_page_model.dart';

class UpdateBillPageWidget extends StatefulWidget {
  const UpdateBillPageWidget({
    super.key,
    required this.whicBill,
  });

  final CompanyBillRecord? whicBill;

  static String routeName = 'updateBillPage';
  static String routePath = '/updateBillPage';

  @override
  State<UpdateBillPageWidget> createState() => _UpdateBillPageWidgetState();
}

class _UpdateBillPageWidgetState extends State<UpdateBillPageWidget> {
  late UpdateBillPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdateBillPageModel());
