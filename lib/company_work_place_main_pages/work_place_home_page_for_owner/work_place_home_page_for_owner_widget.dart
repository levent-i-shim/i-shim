...
class WorkPlaceHomePageForOwnerWidget extends StatefulWidget {
  const WorkPlaceHomePageForOwnerWidget({
    super.key,
  ...
  static String routeName = 'WorkPlaceHomePageForOwner';
  static String routePath = '/workPlaceHomePageForOwner';

  @override
  State<WorkPlaceHomePageForOwnerWidget> createState() =>
      _WorkPlaceHomePageForOwnerWidgetState();
}

class _WorkPlaceHomePageForOwnerWidgetState
    extends State<WorkPlaceHomePageForOwnerWidget> {
  late WorkPlaceHomePageForOwnerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WorkPlaceHomePageForOwnerModel());
                              ...
                              Expanded(
                                ...
                                child: Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      context.pushNamed(
                                        IncomesPageWorkPlaceCopyWidget
                                            .routeName,
                                        queryParameters: {
                              ...
                              Expanded(
                                ...
                                child: Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      context.pushNamed(
                                        PaymentsPageWorkPlaceCopyWidget
                                            .routeName,
                                        queryParameters: {
                                          'company': serializeParam(
                                            widget!.company,
                                ...
                                child: Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      ...
                                      context.pushNamed(VaultsWidget.routeName);
                                    },
                                    child: Container(
                                      height: 102.0,
                                      decoration: BoxDecoration(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              context.pushNamed(
                                WorkPlaceControlCommunicationPageWidget
                                    .routeName,
                                queryParameters: {
                                  'workPlace': serializeParam(
                                    widget!.workPlace,
