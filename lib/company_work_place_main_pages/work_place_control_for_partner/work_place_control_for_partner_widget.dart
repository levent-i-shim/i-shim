...
class WorkPlaceControlForPartnerWidget extends StatefulWidget {
  const WorkPlaceControlForPartnerWidget({
    super.key,
    required this.workPlacePartnership,
  });

  final WorkPlacePartnershipRecord? workPlacePartnership;

  static String routeName = 'workPlaceControlForPartner';
  static String routePath = '/workPlaceControlForPartner';

  @override
  State<WorkPlaceControlForPartnerWidget> createState() =>
      _WorkPlaceControlForPartnerWidgetState();
}

class _WorkPlaceControlForPartnerWidgetState
    extends State<WorkPlaceControlForPartnerWidget> {
  late WorkPlaceControlForPartnerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WorkPlaceControlForPartnerModel());
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      formatNumber(
                                        _model.workPlaceDocument!.yearlyMoney,
                                        formatType: FormatType.decimal,
                                        decimalType: DecimalType.commaDecimal,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      formatNumber(
                                        _model.workPlaceDocument!.totalMoney,
                                        formatType: FormatType.decimal,
                                        decimalType: DecimalType.commaDecimal,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              context.pushNamed(
                                  SettingsEditProfileWidget.routeName);
                            },
                            child: Container(
                              width: 54.0,
                              height: 60.0,
                      ...
                      children: [
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              context.pushNamed(
                                ...
                                queryParameters: {
                                  'workPlace': serializeParam(
                                    _model.workPlaceDocument,
                                    ParamType.Document,
                                  ),
                                }.withoutNulls,
                                extra: <String, dynamic>{
                                  'workPlace': _model.workPlaceDocument,
                                },
                              );
                            },
                            text: 'İş Yeri Künyesi',
                            options: FFButtonOptions(
                              width: double.infinity,
                              height: 40.0,
                              padding: EdgeInsetsDirectional.fromSTEB(
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              context
                                  .pushNamed(SubContractorPageWidget.routeName);
                            },
                            text: 'Sözleşmeler',
                            options: FFButtonOptions(
                              width: double.infinity,
