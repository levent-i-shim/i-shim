...
class CompanyControlForPartnerPageWidget extends StatefulWidget {
  const CompanyControlForPartnerPageWidget({
    super.key,
  ...
  static String routeName = 'CompanyControlForPartnerPage';
  static String routePath = '/companyControlForPartnerPage';

  @override
  State<CompanyControlForPartnerPageWidget> createState() =>
      _CompanyControlForPartnerPageWidgetState();
}

class _CompanyControlForPartnerPageWidgetState
    extends State<CompanyControlForPartnerPageWidget> {
  late CompanyControlForPartnerPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CompanyControlForPartnerPageModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.monthlyWeek = _model.budget?.monthly;
      safeSetState(() {});
    });
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      valueOrDefault<String>(
                                        formatNumber(
                                          _model.companyDetail?.yearlyMoney,
                                          formatType: FormatType.decimal,
                                          decimalType: DecimalType.automatic,
                                        ),
                                        '0',
                                ...
                                context.pushNamed(
                                  ...
                                  queryParameters: {
                                    ...
                                    'workPlace': serializeParam(
                                      _model.companyDetail?.headOffice,
                                      ParamType.DocumentReference,
                                    ),
                                    'isOwner': serializeParam(
                                      false,
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              context
                                  .pushNamed(SolutionPartnerWidget.routeName);
                            },
                            text: 'Çözüm Ortakları',
                            options: FFButtonOptions(
                              width: double.infinity,
                              height: 40.0,
                              padding: EdgeInsetsDirectional.fromSTEB(
