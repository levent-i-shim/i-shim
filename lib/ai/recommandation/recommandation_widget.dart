...
import 'recommandation_model.dart';
export 'recommandation_model.dart';

class RecommandationWidget extends StatefulWidget {
  const RecommandationWidget({super.key});

  static String routeName = 'recommandation';
  static String routePath = '/recommandation';

  @override
  State<RecommandationWidget> createState() => _RecommandationWidgetState();
}

class _RecommandationWidgetState extends State<RecommandationWidget> {
  late RecommandationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RecommandationModel());
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        key: scaffoldKey,
        backgroundColor: Color(0xFF1C51D6),
        appBar: AppBar(
          backgroundColor: Color(0xFF1C51D6),
