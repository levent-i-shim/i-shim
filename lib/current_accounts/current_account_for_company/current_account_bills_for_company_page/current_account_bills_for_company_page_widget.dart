...
class CurrentAccountBillsForCompanyPageWidget extends StatefulWidget {
  const CurrentAccountBillsForCompanyPageWidget({
    super.key,
  ...
  static String routeName = 'CurrentAccountBillsForCompanyPage';
  static String routePath = '/currentAccountBillsForCompanyPage';

  @override
  State<CurrentAccountBillsForCompanyPageWidget> createState() =>
      _CurrentAccountBillsForCompanyPageWidgetState();
}

class _CurrentAccountBillsForCompanyPageWidgetState
    extends State<CurrentAccountBillsForCompanyPageWidget>
    with TickerProviderStateMixin {
  late CurrentAccountBillsForCompanyPageModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => CurrentAccountBillsForCompanyPageModel());
                            ...
                            child: Row(
                              ...
                              children: [
                                Flexible(
                                  flex: 8,
                                  child: Text(
                                    'Bu Hesabı Bir Kullanıcı veya Şirket ile Eşleştirmek istiyor musnuz?',
                                                            ...
                                                            children: [
                                                              Text(
                                                                widget!.currentAccount!
                                                                    ...
                                                                    ? (billItem
                                                                            .isSideOneSeller
                                                                        ? 'Satıcı Taraf Sizsiniz'
                                                                        : 'Satıcı Taraf Karşı Taraf')
                                                                    : (billItem
                                                                            .isSideOneSeller
                                                                        ? 'Satıcı Taraf Karşı Taraf'
                                                                        : 'Satıcı Taraf Sizsiniz'),
