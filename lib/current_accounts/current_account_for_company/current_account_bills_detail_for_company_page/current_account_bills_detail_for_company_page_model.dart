...
import 'current_account_bills_detail_for_company_page_widget.dart'
...
class CurrentAccountBillsDetailForCompanyPageModel
    extends FlutterFlowModel<CurrentAccountBillsDetailForCompanyPageWidget> {
  ...
  // Stores action output result for [Backend Call - Read Document] action in CurrentAccountBillsDetailForCompanyPage widget.
  ...
  // Stores action output result for [Firestore Query - Query a collection] action in Button widget.
  CompanyNotificationsRecord? billNotification;
  // Stores action output result for [Firestore Query - Query a collection] action in Button widget.
  CompanyNotificationsRecord? billNotification2;
  // Stores action output result for [Custom Action - getCompanyDocRef] action in Button widget.
