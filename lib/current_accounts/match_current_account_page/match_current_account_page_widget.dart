...
class MatchCurrentAccountPageWidget extends StatefulWidget {
  const MatchCurrentAccountPageWidget({
    super.key,
    required this.currentAccount,
  });

  final DocumentReference? currentAccount;

  static String routeName = 'MatchCurrentAccountPage';
  static String routePath = '/matchCurrentAccountPage';

  @override
  State<MatchCurrentAccountPageWidget> createState() =>
      _MatchCurrentAccountPageWidgetState();
}

class _MatchCurrentAccountPageWidgetState
    extends State<MatchCurrentAccountPageWidget> {
  late MatchCurrentAccountPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MatchCurrentAccountPageModel());
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      FlutterFlowDropDown<String>(
                        ...
                        options: List<String>.from(['Şahıs', 'Şirket']),
                        optionLabels: [
                          'Kişisel Cari Hesap',
                          'Şirket Cari Hesabı'
                        ],
                        onChanged: (val) async {
                          ...
                          _model.company = _model.sideTwoTypeValue == 'Şirket'
                              ? true
                              : false;
                          _model.user = _model.sideTwoTypeValue == 'Şirket'
                              ? false
                              : true;
                          safeSetState(() {});
                        },
