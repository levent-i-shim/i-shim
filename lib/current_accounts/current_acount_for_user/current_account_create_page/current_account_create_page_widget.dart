...
import 'current_account_create_page_model.dart';
export 'current_account_create_page_model.dart';

class CurrentAccountCreatePageWidget extends StatefulWidget {
  const CurrentAccountCreatePageWidget({super.key});

  static String routeName = 'CurrentAccountCreatePage';
  static String routePath = '/currentAccountCreatePage';

  @override
  State<CurrentAccountCreatePageWidget> createState() =>
      _CurrentAccountCreatePageWidgetState();
}

class _CurrentAccountCreatePageWidgetState
    extends State<CurrentAccountCreatePageWidget> {
  late CurrentAccountCreatePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CurrentAccountCreatePageModel());
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            'Kişisel Hesabınız için Cari Hesap Oluşturuluyor',
                    ...
                    children: [
                      ...
                      FlutterFlowDropDown<String>(
                        ...
                        onChanged: (val) async {
                          ...
                          _model.isSelectedNotUserForCounter =
                      ...
                      if (_model.isSelectedNotUserForCounter)
                        Padding(
                            ...
                            onPressed: () async {
                              ...
                              await currentAccountRecordReference.set({
                                ...createCurrentAccountRecordData(
                                  sideOneType: 'Şirket',
                                  sideOneID: currentUserReference?.id,
                                                          ...
                                                          onPressed: () async {
                                                            ...
                                                            await NotificationsRecord
                                                              ...
                                                              ...createNotificationsRecordData(
                                                                ...
                                                                isDelete: false,
                                                                fullDescription:
                                                                    '${currentUserDisplayName} İsimli Kişi Cari Hesap Açmak istiyor.',
                                                                image:
                                                                    currentUserPhoto,
                                                              ),
                                                              ...mapToFirestore(
                                                            ...
                                                            await CompanyNotificationsRecord
                                                              ...
                                                              ...createCompanyNotificationsRecordData(
                                                                ...
                                                                currentAccount: _model
                                                                    ...
                                                                    ?.reference,
                                                                fullDescription:
                                                                    '${searcResultForCompanyItem.name} İsimli Şirket Şirketinizle Cari Hesap Oluşturmak istiyor.',
                                                                image: searcResultForCompanyItem
                                                                    .companyLogo,
                                                                isAccept: false,
                                                              ),
                                                              ...mapToFirestore(
