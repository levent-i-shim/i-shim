...
class CurrentAccountBillsPageWidget extends StatefulWidget {
  const CurrentAccountBillsPageWidget({
    super.key,
  ...
  static String routeName = 'CurrentAccountBillsPage';
  static String routePath = '/currentAccountBillsPage';

  @override
  State<CurrentAccountBillsPageWidget> createState() =>
      _CurrentAccountBillsPageWidgetState();
}

class _CurrentAccountBillsPageWidgetState
    extends State<CurrentAccountBillsPageWidget> with TickerProviderStateMixin {
  late CurrentAccountBillsPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CurrentAccountBillsPageModel());
