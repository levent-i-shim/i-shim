...
class StockOperationPageWidget extends StatefulWidget {
  const StockOperationPageWidget({
    super.key,
    required this.stock,
  });
  ...
  static String routeName = 'StockOperationPage';
  static String routePath = '/stockOperationPage';

  @override
  State<StockOperationPageWidget> createState() =>
      _StockOperationPageWidgetState();
}

class _StockOperationPageWidgetState extends State<StockOperationPageWidget> {
  late StockOperationPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StockOperationPageModel());
                                    ...
                                    if (_model.validate!) {
                                      ...
                                      await AjandaRecord.createDoc(
                                        ...
                                        ...createAjandaRecordData(
                                          description: 'Stok Arttırıldı',
                                          type: WorkHistoryTypes
                                              .createStockMovement.name,
                                          stockMovement:
                                              _model.stockMovement3?.reference,
                                          fullDescription:
                                  ...
                                  onPressed: () async {
                                    ...
                                    if (_model.validate2!) {
                                      ...
                                      await AjandaRecord.createDoc(
                                          ...
                                          .set({
                                        ...createAjandaRecordData(
                                          description: 'Stok Azaltıldı',
                                          type: WorkHistoryTypes
                                              .createStockMovement.name,
                                          stockMovement:
                                              _model.stockMovement4?.reference,
                                          fullDescription:
