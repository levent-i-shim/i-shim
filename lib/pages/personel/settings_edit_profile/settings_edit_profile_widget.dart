...
class _SettingsEditProfileWidgetState extends State<SettingsEditProfileWidget> {
  ...
  void initState() {
    ...
    _model.textController4 ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.birthCity, ''));
    _model.textFieldFocusNode4 ??= FocusNode();

    _model.textFieldAboutMeTextController ??= TextEditingController(
            ...
            children: [
                                            ...
                                            Padding(
                                              padding: EdgeInsetsDirectional
                                                  .fromSTEB(
                                                      8.0, 4.0, 12.0, 0.0),
                                              child: Text(
                                                'Telefon numaranı bağlayarak hesabının güvenliğini arttır',
                                                style:
                ...
                onPressed: () async {
                  if (_model.textController1.text != null &&
                    ...
                    if (currentPhoneNumber != _model.textController1.text) {
                      ...
                      await PhoneIndexRecord.collection
                          .doc(_model.docId!)
                          .set(createPhoneIndexRecordData(
                  ...
                  await currentUserReference!.update(createUsersRecordData(
                    ...
                    birthCity: _model.textController4.text,
                  ));
                  ...
                  children: [
                    Expanded(
                      child: Padding(
                        ...
                        child: AuthUserStreamWidget(
                          builder: (context) => TextFormField(
                            controller: _model.textFieldAboutMeTextController,
                ...
                onPressed: () async {
                  await currentUserReference!.update({
                    ...createUsersRecordData(
                      aboutMe: _model.textFieldAboutMeTextController.text,
                    ),
                    ...mapToFirestore(
                      {
                        'aboutMeUpdatedAt': FieldValue.serverTimestamp(),
                      },
                    ),
                  });
                  ScaffoldMessenger.of(context).showSnackBar(
              ...
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    _model.changePasswordReturn =
                        await actions.changeUsersPassword(
              ...
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    await SQLiteManager.instance.deleteConversations();
                    await SQLiteManager.instance.deleteMessages();
                    await SQLiteManager.instance.deleteCompanyWorkers();
                    FFAppState().localDbLastUpdatedAt = getCurrentTimestamp;
