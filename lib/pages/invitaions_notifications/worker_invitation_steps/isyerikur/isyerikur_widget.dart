...
class IsyerikurWidget extends StatefulWidget {
  const IsyerikurWidget({
    super.key,
    bool? invitation,
  ...
  static String routeName = 'isyerikur';
  static String routePath = '/kur';

  @override
  State<IsyerikurWidget> createState() => _IsyerikurWidgetState();
}

class _IsyerikurWidgetState extends State<IsyerikurWidget> {
  late IsyerikurModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => IsyerikurModel());
