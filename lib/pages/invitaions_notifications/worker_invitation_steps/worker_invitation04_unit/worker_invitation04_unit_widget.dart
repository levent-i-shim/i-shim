...
class WorkerInvitation04UnitWidget extends StatefulWidget {
  const WorkerInvitation04UnitWidget({
    super.key,
  ...
  static String routeName = 'workerInvitation04Unit';
  static String routePath = '/workerInvitation04Unit';

  @override
  State<WorkerInvitation04UnitWidget> createState() =>
      _WorkerInvitation04UnitWidgetState();
}

class _WorkerInvitation04UnitWidgetState
    extends State<WorkerInvitation04UnitWidget> {
  late WorkerInvitation04UnitModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WorkerInvitation04UnitModel());
                          ...
                          child: StreamBuilder<List<CompanyUnitsRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<CompanyUnitsRecord>
                                  result01CompanyUnitsRecordList =
                                  snapshot.data!;
                              ...
                              return ListView.builder(
                                ...
                                itemCount:
                                    result01CompanyUnitsRecordList.length,
                                itemBuilder: (context, result01Index) {
                                  final result01CompanyUnitsRecord =
                                      result01CompanyUnitsRecordList[
                                          result01Index];
                                  return Padding(
