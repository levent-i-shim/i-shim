...
class WorkerInvitation07SalaryWidget extends StatefulWidget {
  const WorkerInvitation07SalaryWidget({
    super.key,
  ...
  final DocumentReference? workerRole;
  final String? workPlaceName;
  final bool? routeBack;

  static String routeName = 'WorkerInvitation07Salary';
  static String routePath = '/workerInvitation07Salary';

  @override
  State<WorkerInvitation07SalaryWidget> createState() =>
      _WorkerInvitation07SalaryWidgetState();
}

class _WorkerInvitation07SalaryWidgetState
    extends State<WorkerInvitation07SalaryWidget> {
  late WorkerInvitation07SalaryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WorkerInvitation07SalaryModel());
