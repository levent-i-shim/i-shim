...
class SendInvitationDetailWidget extends StatefulWidget {
  const SendInvitationDetailWidget({
    super.key,
    required this.invitation,
  });

  final InvitationsRecord? invitation;

  static String routeName = 'SendInvitationDetail';
  static String routePath = '/sendInvitationDetail';

  @override
  State<SendInvitationDetailWidget> createState() =>
      _SendInvitationDetailWidgetState();
}

class _SendInvitationDetailWidgetState
    extends State<SendInvitationDetailWidget> {
  late SendInvitationDetailModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SendInvitationDetailModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.roleNameVariable = _model.roleName!;
      safeSetState(() {});
    });
              ...
              Padding(
                ...
                child: StreamBuilder<WorkPlacesRecord>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    final rowWorkPlacesRecord = snapshot.data!;
                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    await _model.notifi2!.reference
