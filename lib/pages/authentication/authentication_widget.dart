            ...
            child: Stack(
              children: [
                Align(
                  ...
                  child: Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(60.0, 30.0, 60.0, 15.0),
                    child: Container(
                      width: 1920.0,
                      height: 160.0,
                                                                    ...
                                                                    : Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onPressed:
                                                                            ...
                                                                            await AjandaRecord.createDoc(currentUserReference!).set({
                                                                              ...createAjandaRecordData(
                                                                                description: 'Hesap Oluşturuldu',
                                                                                type: WorkHistoryTypes.createAccount.name,
                                                                              ),
                                                                              ...mapToFirestore(
                                                                                {
                                                    ...
                                                    padding:
                                                        EdgeInsetsDirectional
                                                            .fromSTEB(0.0, 4.0,
                                                                0.0, 24.0),
                                                    child: Text(
                                                      'Hesabınıza giriş yapmak için aşağıdaki alanları doldurun.',
                                                      textAlign:
                                                          TextAlign.start,
                                                      style:
                                                          FlutterFlowTheme.of(
                                                      ...
                                                      padding:
                                                          EdgeInsetsDirectional
                                                              .fromSTEB(
                                                                  ...
                                                                  24.0),
                                                      child: Text(
                                                        'Ya da aşağıdakilerle giriş yap',
                                                        textAlign:
                                                            TextAlign.center,
                                                        style:
                                                            FlutterFlowTheme.of(
