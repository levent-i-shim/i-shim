...
import 'fabrika_kur_model.dart';
export 'fabrika_kur_model.dart';

class FabrikaKurWidget extends StatefulWidget {
  const FabrikaKurWidget({
    super.key,
    bool? invitation,
  ...
  static String routeName = 'FabrikaKur';
  static String routePath = '/FabrikaKur';

  @override
  State<FabrikaKurWidget> createState() => _FabrikaKurWidgetState();
}

class _FabrikaKurWidgetState extends State<FabrikaKurWidget> {
  late FabrikaKurModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FabrikaKurModel());
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintText: 'Fabrikanın adı ne olsun ?',
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    if (_model.validateForm!) {
                                      ...
                                      await workPlacesRecordReference
                                          .set(createWorkPlacesRecordData(
                                        ...
                                        type: WorkPlaceTypes.factory.name,
                                      ));
                                      _model.workPlace =
                                          ...
                                          await showDialog<bool>(
                                                ...
                                                builder: (alertDialogContext) {
                                                  return AlertDialog(
                                                    ...
                                                    content: Text(
                                                        'Şantiye oluşturulduktan sonra, otomatik olarak standart departmanlar, birimler ve roller eklenecektir. Bu işlem organizasyon şemanızı hızlıca oluşturmanızı sağlar. Devam etmek istiyor musunuz?'),
                                                    actions: [
                                                      TextButton(
                                                        onPressed: () =>
                                                            Navigator.pop(
                                      ...
                                      if (confirmDialogResponse) {
                                        await actions
                                            .createDefaultDepartmentsUnitsAndRolesForFactory(
                                          _model.selectedCompany!,
                                          _model.workPlace!.reference,
                                          currentUserReference!,
                                        );
