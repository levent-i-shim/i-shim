...
class SantiyeKurWidget extends StatefulWidget {
  const SantiyeKurWidget({
    super.key,
    bool? invitation,
  ...
  static String routeName = 'SantiyeKur';
  static String routePath = '/SantiyeKur';

  @override
  State<SantiyeKurWidget> createState() => _SantiyeKurWidgetState();
}

class _SantiyeKurWidgetState extends State<SantiyeKurWidget> {
  late SantiyeKurModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SantiyeKurModel());
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintText: 'Şantiyenin adı ne olsun ?',
                                  ...
                                  onPressed: () async {
                                    ...
                                    if (_model.validateForm!) {
                                      ...
                                      if (confirmDialogResponse) {
                                        await actions
                                            .createDefaultDepartmentsUnitsAndRolesForConstructionSite(
                                          _model.selectedCompany!,
                                          _model.workPlace!.reference,
                                          currentUserReference!,
                                        );
