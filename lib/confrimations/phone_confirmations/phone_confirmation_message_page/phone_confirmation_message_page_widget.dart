...
class PhoneConfirmationMessagePageWidget extends StatefulWidget {
  const PhoneConfirmationMessagePageWidget({
    super.key,
    required this.confirmation,
  });

  final PhoneConfirmationsRecord? confirmation;

  static String routeName = 'PhoneConfirmationMessagePage';
  static String routePath = '/phoneConfirmationMessagePage';

  @override
  State<PhoneConfirmationMessagePageWidget> createState() =>
      _PhoneConfirmationMessagePageWidgetState();
}

class _PhoneConfirmationMessagePageWidgetState
    extends State<PhoneConfirmationMessagePageWidget> {
  late PhoneConfirmationMessagePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PhoneConfirmationMessagePageModel());
                  ...
                  child: StreamBuilder<List<PhoneConfirmationMessagesRecord>>(
                    stream: queryPhoneConfirmationMessagesRecord(
                      ...
                      queryBuilder: (phoneConfirmationMessagesRecord) =>
                        ...
                        List<PhoneConfirmationMessagesRecord>
                            listViewPhoneConfirmationMessagesRecordList =
                            snapshot;
                        if (_model.listViewPreviousSnapshot != null &&
                            !const ListEquality(
                                    PhoneConfirmationMessagesRecordDocumentEquality())
                                .equals(
                                    listViewPhoneConfirmationMessagesRecordList,
                    ...
                    builder: (context, snapshot) {
                      ...
                      return ListView.builder(
                        ...
                        itemCount:
                            listViewPhoneConfirmationMessagesRecordList.length,
                        itemBuilder: (context, listViewIndex) {
                          final listViewPhoneConfirmationMessagesRecord =
                              listViewPhoneConfirmationMessagesRecordList[
                                  listViewIndex];
                          return Stack(
                            children: [
                              if (listViewPhoneConfirmationMessagesRecord
                                      .receiverRef ==
                                  currentUserReference)
                                Padding(
                                      ...
                                      InkWell(
                                        ...
                                        onLongPress: () async {
                                          await Clipboard.setData(ClipboardData(
                                              text:
                                                  listViewPhoneConfirmationMessagesRecord
                                                      .message));
                                                        ...
                                                        await Navigator.push(
                                                          ...
                                                          PageTransition(
                                                            ...
                                                            child:
                                                              ...
                                                              allowRotation:
                                                                  false,
                                                              tag: listViewPhoneConfirmationMessagesRecord
                                                                  .imagePath,
                                                              useHeroAnimation:
                                                                  true,
                                                            ),
                                          ...
                                          if (_model.selectedPdf) {
                                            ...
                                            await PhoneConfirmationMessagesRecord
                                                    .createDoc(widget
                                                        ...
                                                        .reference)
                                                .set({
                                              ...createPhoneConfirmationMessagesRecordData(
                                                message:
                                                    _model.textController.text,
                                                senderRef: currentUserReference,
                                                receiverRef: _model.receiver,
                                                isRead: false,
                                              ),
                                              ...mapToFirestore(
                                                {
