...
class ConfirmationUserDetailPageWidget extends StatefulWidget {
  const ConfirmationUserDetailPageWidget({
    super.key,
  ...
  static String routeName = 'confirmationUserDetailPage';
  static String routePath = '/confirmationUserDetailPage';

  @override
  State<ConfirmationUserDetailPageWidget> createState() =>
      _ConfirmationUserDetailPageWidgetState();
}

class _ConfirmationUserDetailPageWidgetState
    extends State<ConfirmationUserDetailPageWidget> {
  late ConfirmationUserDetailPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ConfirmationUserDetailPageModel());
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                                  ...
                                  children: [
                                    ...
                                    FutureBuilder<
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        final containerGetMessageMediaCountRowList =
                                            snapshot.data!;
                                    ...
                                    return SingleChildScrollView(
                                      ...
                                      child: Row(
                                        ...
                                        children: List.generate(
                                            rowGetLastImagesRowList.length,
                                            (rowIndex) {
                                          final rowGetLastImagesRow =
                                              rowGetLastImagesRowList[rowIndex];
                                          return Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 0.0, 8.0, 0.0),
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    context.pushNamed(
                                      ConfirmationStarredMessagesPageWidget
                                          .routeName,
                                      queryParameters: {
                                        'conversationId': serializeParam(
                                          widget.conversationId,
                                      ...
                                      Padding(
                                        ...
                                        child: FutureBuilder<
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            final textGetMessageStarredCountRowList =
                                                snapshot.data!;
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    12.0, 4.0, 0.0, 0.0),
                                            child: Text(
                                              'Bu sohbeti bu cihazda kilitleyin ve gizleyin',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                                      .override(
                  ...
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(4.0, 8.0, 4.0, 50.0),
                    child: Material(
                      color: Colors.transparent,
                      elevation: 3.0,
                      child: Container(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                        ...
                                        await showDialog<bool>(
                                              ...
                                              builder: (alertDialogContext) {
                                                return AlertDialog(
                                                  ...
                                                  content: Text(
                                                      'Bu kişi artık size hiç bir yerden mesaj gönderemeyecek'),
                                                  actions: [
                                                    TextButton(
                                                      onPressed: () =>
                                                          Navigator.pop(
                                    ...
                                    if (confirmDialogResponse) {
                                      ...
                                      await BlockedConversationsRecord
                                    ...
                                    var confirmDialogResponse =
                                        await showDialog<bool>(
                                              ...
                                              builder: (alertDialogContext) {
                                                return AlertDialog(
                                                  title: Text(
                                                      'İ-SHİM\'e şikayet edin'),
                                                  content: Text(
                                                      'Bu sohbetteki mesajlar İ-SHİM\'e gönderilecek. Şikayet hakkında bu kişiye bilgi verilmeyecek'),
                                                  actions: [
                                                    TextButton(
                                                      onPressed: () =>
                                                          Navigator.pop(
                                            ...
                                            false;
                                    if (confirmDialogResponse) {
                                      await ConversationReportsRecord.collection
                                          .doc()
                                          .set({
