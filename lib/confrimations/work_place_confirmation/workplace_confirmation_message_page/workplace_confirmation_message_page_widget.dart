...
class WorkplaceConfirmationMessagePageWidget extends StatefulWidget {
  const WorkplaceConfirmationMessagePageWidget({
    super.key,
    required this.workplaceConfirmation,
  });

  final WorkplaceConfirmationsRecord? workplaceConfirmation;

  static String routeName = 'WorkplaceConfirmationMessagePage';
  static String routePath = '/workplaceConfirmationMessagePage';

  @override
  State<WorkplaceConfirmationMessagePageWidget> createState() =>
      _WorkplaceConfirmationMessagePageWidgetState();
}

class _WorkplaceConfirmationMessagePageWidgetState
    extends State<WorkplaceConfirmationMessagePageWidget> {
  late WorkplaceConfirmationMessagePageModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => WorkplaceConfirmationMessagePageModel());
                  ...
                  child:
                    ...
                    stream: queryWorkplaceConfirmationMessageRecord(
                      ...
                      queryBuilder: (workplaceConfirmationMessageRecord) =>
                        ...
                        List<WorkplaceConfirmationMessageRecord>
                            listViewWorkplaceConfirmationMessageRecordList =
                            snapshot;
                        if (_model.listViewPreviousSnapshot != null &&
                            !const ListEquality(
                                    WorkplaceConfirmationMessageRecordDocumentEquality())
                                .equals(
                                    listViewWorkplaceConfirmationMessageRecordList,
                    ...
                    builder: (context, snapshot) {
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, listViewIndex) {
                          final listViewWorkplaceConfirmationMessageRecord =
                              listViewWorkplaceConfirmationMessageRecordList[
                                  listViewIndex];
                          return Stack(
                            children: [
                              if (listViewWorkplaceConfirmationMessageRecord
                                      .receiverRef ==
                                  currentUserReference)
                                Padding(
                                      ...
                                      InkWell(
                                        ...
                                        onLongPress: () async {
                                          await Clipboard.setData(ClipboardData(
                                              text:
                                                  listViewWorkplaceConfirmationMessageRecord
                                                      .message));
                                                        ...
                                                        await Navigator.push(
                                                          ...
                                                          PageTransition(
                                                            ...
                                                            child:
                                                              ...
                                                              allowRotation:
                                                                  false,
                                                              tag: listViewWorkplaceConfirmationMessageRecord
                                                                  .imagePath,
                                                              useHeroAnimation:
                                                                  true,
                                                            ),
