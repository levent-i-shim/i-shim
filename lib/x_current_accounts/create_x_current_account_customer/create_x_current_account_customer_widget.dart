...
import 'create_x_current_account_customer_model.dart';
export 'create_x_current_account_customer_model.dart';

class CreateXCurrentAccountCustomerWidget extends StatefulWidget {
  const CreateXCurrentAccountCustomerWidget({super.key});

  static String routeName = 'createXCurrentAccountCustomer';
  static String routePath = '/createXCurrentAccount';

  @override
  State<CreateXCurrentAccountCustomerWidget> createState() =>
      _CreateXCurrentAccountCustomerWidgetState();
}

class _CreateXCurrentAccountCustomerWidgetState
    extends State<CreateXCurrentAccountCustomerWidget> {
  late CreateXCurrentAccountCustomerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateXCurrentAccountCustomerModel());
