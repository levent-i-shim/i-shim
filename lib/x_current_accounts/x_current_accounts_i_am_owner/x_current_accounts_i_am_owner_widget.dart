...
import 'x_current_accounts_i_am_owner_model.dart';
export 'x_current_accounts_i_am_owner_model.dart';

class XCurrentAccountsIAmOwnerWidget extends StatefulWidget {
  const XCurrentAccountsIAmOwnerWidget({
    super.key,
  ...
  static String routeName = 'xCurrentAccountsIAmOwner';
  static String routePath = '/xCurrentAccountsIAmOwner';

  @override
  State<XCurrentAccountsIAmOwnerWidget> createState() =>
      _XCurrentAccountsIAmOwnerWidgetState();
}

class _XCurrentAccountsIAmOwnerWidgetState
    extends State<XCurrentAccountsIAmOwnerWidget>
    with TickerProviderStateMixin {
  late XCurrentAccountsIAmOwnerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => XCurrentAccountsIAmOwnerModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<CompaniesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CompaniesRecord> xCurrentAccountsIAmOwnerCompaniesRecordList =
            snapshot.data!;
