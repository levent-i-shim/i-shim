...
import 'create_x_current_account_supplier_model.dart';
export 'create_x_current_account_supplier_model.dart';

class CreateXCurrentAccountSupplierWidget extends StatefulWidget {
  const CreateXCurrentAccountSupplierWidget({super.key});

  static String routeName = 'createXCurrentAccountSupplier';
  static String routePath = '/createXCurrentAccountSupplier';

  @override
  State<CreateXCurrentAccountSupplierWidget> createState() =>
      _CreateXCurrentAccountSupplierWidgetState();
}

class _CreateXCurrentAccountSupplierWidgetState
    extends State<CreateXCurrentAccountSupplierWidget> {
  late CreateXCurrentAccountSupplierModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateXCurrentAccountSupplierModel());
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      ...
                      if (_model.ownerOrWorkerValue == 'ownerOrPartner') {
                        ...
                        await XCurrentAccountsRecord.collection
                            .doc()
                            .set(createXCurrentAccountsRecordData(
