...
class XCurrentItemsWidget extends StatefulWidget {
  const XCurrentItemsWidget({
    super.key,
  ...
  static String routeName = 'xCurrentItems';
  static String routePath = '/xCurrentItems';

  @override
  State<XCurrentItemsWidget> createState() => _XCurrentItemsWidgetState();
}

class _XCurrentItemsWidgetState extends State<XCurrentItemsWidget>
    with TickerProviderStateMixin {
  late XCurrentItemsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => XCurrentItemsModel());
                                ...
                                Container(
                                  ...
                                  child: Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        10.0, 4.0, 10.0, 4.0),
                                    child: Text(
                                      'Ödenmesi Planlanan Toplam Meblağ :',
                                      style: FlutterFlowTheme.of(context)
                                          .labelMedium
                                          .override(
                                            font: GoogleFonts.inter(
                            ...
                            children: [
                              StreamBuilder<List<XCurrentActivitiesRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<XCurrentActivitiesRecord>
                                      listViewXCurrentActivitiesRecordList =
                                      snapshot.data!;
                                  ...
                                  return ListView.builder(
                                    ...
                                    itemBuilder: (context, listViewIndex) {
                                      final listViewXCurrentActivitiesRecord =
                                          listViewXCurrentActivitiesRecordList[
                                              listViewIndex];
                                      return Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
