...
import 'x_current_accounts_personel_model.dart';
export 'x_current_accounts_personel_model.dart';

class XCurrentAccountsPersonelWidget extends StatefulWidget {
  const XCurrentAccountsPersonelWidget({
    super.key,
  ...
  static String routeName = 'xCurrentAccountsPersonel';
  static String routePath = '/xCurrentAccountsPersonel';

  @override
  State<XCurrentAccountsPersonelWidget> createState() =>
      _XCurrentAccountsPersonelWidgetState();
}

class _XCurrentAccountsPersonelWidgetState
    extends State<XCurrentAccountsPersonelWidget>
    with TickerProviderStateMixin {
  late XCurrentAccountsPersonelModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => XCurrentAccountsPersonelModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<CompaniesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CompaniesRecord> xCurrentAccountsPersonelCompaniesRecordList =
            snapshot.data!;
