...
import 'create_x_current_account_mixed_model.dart';
export 'create_x_current_account_mixed_model.dart';

class CreateXCurrentAccountMixedWidget extends StatefulWidget {
  const CreateXCurrentAccountMixedWidget({super.key});

  static String routeName = 'createXCurrentAccountMixed';
  static String routePath = '/createXCurrentAccountMixed';

  @override
  State<CreateXCurrentAccountMixedWidget> createState() =>
      _CreateXCurrentAccountMixedWidgetState();
}

class _CreateXCurrentAccountMixedWidgetState
    extends State<CreateXCurrentAccountMixedWidget> {
  late CreateXCurrentAccountMixedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateXCurrentAccountMixedModel());
