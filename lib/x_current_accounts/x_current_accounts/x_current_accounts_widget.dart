...
import 'x_current_accounts_model.dart';
export 'x_current_accounts_model.dart';

class XCurrentAccountsWidget extends StatefulWidget {
  const XCurrentAccountsWidget({
    super.key,
  ...
  static String routeName = 'xCurrentAccounts';
  static String routePath = '/xCurrentAccounts';

  @override
  State<XCurrentAccountsWidget> createState() => _XCurrentAccountsWidgetState();
}

class _XCurrentAccountsWidgetState extends State<XCurrentAccountsWidget>
    with TickerProviderStateMixin {
  late XCurrentAccountsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => XCurrentAccountsModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<CompaniesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CompaniesRecord> xCurrentAccountsCompaniesRecordList =
            snapshot.data!;
