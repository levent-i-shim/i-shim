...
import 'c_v_page_model.dart';
export 'c_v_page_model.dart';

class CVPageWidget extends StatefulWidget {
  const CVPageWidget({super.key});

  static String routeName = 'CVPage';
  static String routePath = '/cVPage';
                                          ...
                                          children: [
                                            ...
                                            Align(
                                              alignment: AlignmentDirectional(
                                                  -1.0, 0.0),
                                              child: Text(
                                                listViewWorkHistoryRecord.unit,
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .bodyMedium
                                                    .override(
                                            ...
                                            Align(
                                              alignment: AlignmentDirectional(
                                                  -1.0, 0.0),
                                              child: Text(
                                                listViewWorkHistoryRecord.role,
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .bodyMedium
                                                    .override(
                                              ...
                                              child: Padding(
                                                padding: EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        0.0, 4.0, 0.0, 0.0),
                                                child: Text(
                                                  '${dateTimeFormat("d/M/y", listViewWorkHistoryRecord.startDate)} - ${listViewWorkHistoryRecord.hasEndDate() ? dateTimeFormat("d/M/y", listViewWorkHistoryRecord.endDate) : 'Present'}',
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium
                                                      .override(
