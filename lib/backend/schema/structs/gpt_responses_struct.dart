...
class GptResponsesStruct extends FFFirebaseStruct {
  GptResponsesStruct({
    String? id,
    String? object,
    int? created,
  ...
  static GptResponsesStruct fromMap(Map<String, dynamic> data) =>
      GptResponsesStruct(
  ...
  static GptResponsesStruct? maybeFromMap(dynamic data) => data is Map
      ? GptResponsesStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static GptResponsesStruct fromSerializableMap(Map<String, dynamic> data) =>
      GptResponsesStruct(
        id: deserializeParam(
          data['id'],
          ParamType.String,
  ...
  @override
  String toString() => 'GptResponsesStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    const listEquality = ListEquality();
    return other is GptResponsesStruct &&
        id == other.id &&
        object == other.object &&
...
GptResponsesStruct createGptResponsesStruct({
  String? id,
  String? object,
  int? created,
  String? model,
...
GptResponsesStruct? updateGptResponsesStruct(
  GptResponsesStruct? gptResponses, {
  bool clearUnsetFields = true,
  bool create = false,
}) =>
    gptResponses
...
void addGptResponsesStructData(
  ...
  if (gptResponses.firestoreUtilData.delete) {
    firestoreData[fieldName] = FieldValue.delete();
    return;
  }
  final clearFields =
      !forFieldValue && gptResponses.firestoreUtilData.clearUnsetFields;
  if (clearFields) {
    firestoreData[fieldName] = <String, dynamic>{};
  }
  final gptResponsesData =
      getGptResponsesFirestoreData(gptResponses, forFieldValue);
  final nestedData =
      gptResponsesData.map((k, v) => MapEntry('$fieldName.$k', v));

  final mergeFields = gptResponses.firestoreUtilData.create || clearFields;
  firestoreData
      .addAll(mergeFields ? mergeNestedFields(nestedData) : nestedData);
}

Map<String, dynamic> getGptResponsesFirestoreData(
  GptResponsesStruct? gptResponses, [
  bool forFieldValue = false,
]) {
  if (gptResponses == null) {
  ...
  final firestoreData = mapToFirestore(gptResponses.toMap());

  // Handle nested data for "usage" field.
  addUsageStructData(
    firestoreData,
    gptResponses.hasUsage() ? gptResponses.usage : null,
    'usage',
    forFieldValue,
  );

  // Add any Firestore field values
  gptResponses.firestoreUtilData.fieldValues
      .forEach((k, v) => firestoreData[k] = v);

  return forFieldValue ? mergeNestedFields(firestoreData) : firestoreData;
}

List<Map<String, dynamic>> getGptResponsesListFirestoreData(
  List<GptResponsesStruct>? gptResponsess,
) =>
    gptResponsess?.map((e) => getGptResponsesFirestoreData(e, true)).toList() ??
    [];
