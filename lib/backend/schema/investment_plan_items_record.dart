...
class InvestmentPlanItemsRecord extends FirestoreRecord {
  InvestmentPlanItemsRecord._(
  ...
  static Query<Map<String, dynamic>> collection([DocumentReference? parent]) =>
      parent != null
          ? parent.collection('investmentPlanItems')
          : FirebaseFirestore.instance.collectionGroup('investmentPlanItems');

  static DocumentReference createDoc(DocumentReference parent, {String? id}) =>
      parent.collection('investmentPlanItems').doc(id);

  static Stream<InvestmentPlanItemsRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => InvestmentPlanItemsRecord.fromSnapshot(s));

  static Future<InvestmentPlanItemsRecord> getDocumentOnce(
          DocumentReference ref) =>
      ref.get().then((s) => InvestmentPlanItemsRecord.fromSnapshot(s));

  static InvestmentPlanItemsRecord fromSnapshot(DocumentSnapshot snapshot) =>
      InvestmentPlanItemsRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static InvestmentPlanItemsRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      InvestmentPlanItemsRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'InvestmentPlanItemsRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is InvestmentPlanItemsRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createInvestmentPlanItemsRecordData({
  String? title,
  double? value,
  String? content,
...
class InvestmentPlanItemsRecordDocumentEquality
    implements Equality<InvestmentPlanItemsRecord> {
  const InvestmentPlanItemsRecordDocumentEquality();

  @override
  bool equals(InvestmentPlanItemsRecord? e1, InvestmentPlanItemsRecord? e2) {
  ...
  @override
  int hash(InvestmentPlanItemsRecord? e) => const ListEquality().hash([
        e?.title,
        e?.value,
        e?.content,
        e?.creationTime,
  ...
  @override
  bool isValidKey(Object? o) => o is InvestmentPlanItemsRecord;
}
