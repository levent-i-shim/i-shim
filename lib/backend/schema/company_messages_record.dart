...
class CompanyMessagesRecord extends FirestoreRecord {
  CompanyMessagesRecord._(
  ...
  static Query<Map<String, dynamic>> collection([DocumentReference? parent]) =>
      parent != null
          ? parent.collection('companyMessages')
          : FirebaseFirestore.instance.collectionGroup('companyMessages');

  static DocumentReference createDoc(DocumentReference parent, {String? id}) =>
      parent.collection('companyMessages').doc(id);

  static Stream<CompanyMessagesRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => CompanyMessagesRecord.fromSnapshot(s));

  static Future<CompanyMessagesRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => CompanyMessagesRecord.fromSnapshot(s));

  static CompanyMessagesRecord fromSnapshot(DocumentSnapshot snapshot) =>
      CompanyMessagesRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static CompanyMessagesRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      CompanyMessagesRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'CompanyMessagesRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is CompanyMessagesRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createCompanyMessagesRecordData({
  String? message,
...
class CompanyMessagesRecordDocumentEquality
    implements Equality<CompanyMessagesRecord> {
  const CompanyMessagesRecordDocumentEquality();

  @override
  bool equals(CompanyMessagesRecord? e1, CompanyMessagesRecord? e2) {
  ...
  @override
  int hash(CompanyMessagesRecord? e) => const ListEquality().hash([
        e?.message,
        e?.senderRef,
        e?.receiverRef,
        e?.isRead,
  ...
  @override
  bool isValidKey(Object? o) => o is CompanyMessagesRecord;
}
