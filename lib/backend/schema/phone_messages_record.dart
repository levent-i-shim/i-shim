...
class PhoneMessagesRecord extends FirestoreRecord {
  PhoneMessagesRecord._(
  ...
  static Query<Map<String, dynamic>> collection([DocumentReference? parent]) =>
      parent != null
          ? parent.collection('phoneMessages')
          : FirebaseFirestore.instance.collectionGroup('phoneMessages');

  static DocumentReference createDoc(DocumentReference parent, {String? id}) =>
      parent.collection('phoneMessages').doc(id);

  static Stream<PhoneMessagesRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => PhoneMessagesRecord.fromSnapshot(s));

  static Future<PhoneMessagesRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => PhoneMessagesRecord.fromSnapshot(s));

  static PhoneMessagesRecord fromSnapshot(DocumentSnapshot snapshot) =>
      PhoneMessagesRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static PhoneMessagesRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      PhoneMessagesRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'PhoneMessagesRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is PhoneMessagesRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createPhoneMessagesRecordData({
  String? message,
...
class PhoneMessagesRecordDocumentEquality
    implements Equality<PhoneMessagesRecord> {
  const PhoneMessagesRecordDocumentEquality();

  @override
  bool equals(PhoneMessagesRecord? e1, PhoneMessagesRecord? e2) {
  ...
  @override
  int hash(PhoneMessagesRecord? e) => const ListEquality().hash([
        e?.message,
        e?.senderRef,
        e?.receiverRef,
        e?.isRead,
  ...
  @override
  bool isValidKey(Object? o) => o is PhoneMessagesRecord;
}
