...
import 'dart:ui';
import 'sent_money_for_allowence_page_widget.dart'
...
class SentMoneyForAllowencePageModel
    extends FlutterFlowModel<SentMoneyForAllowencePageWidget> {
  ...
  bool isDataUploading_uploadDataHqc = false;
  FFUploadedFile uploadedLocalFile_uploadDataHqc =
      FFUploadedFile(bytes: Uint8List.fromList([]), originalFilename: '');

  // Stores action output result for [Backend Call - Read Document] action in Button widget.
  CompaniesRecord? copmanyDetailMoney;
  // Stores action output result for [Backend Call - Read Document] action in Button widget.
  CompanyWorkersRecord? companyWorkerDetail;
  bool isDataUploading_uploadDataA64 = false;
  FFUploadedFile uploadedLocalFile_uploadDataA64 =
      FFUploadedFile(bytes: Uint8List.fromList([]), originalFilename: '');
  String uploadedFileUrl_uploadDataA64 = '';
