...
class ExpandituriesPageWidget extends StatefulWidget {
  const ExpandituriesPageWidget({
    super.key,
  ...
  static String routeName = 'ExpandituriesPage';
  static String routePath = '/expandituriesPage';

  @override
  State<ExpandituriesPageWidget> createState() =>
      _ExpandituriesPageWidgetState();
}

class _ExpandituriesPageWidgetState extends State<ExpandituriesPageWidget> {
  late ExpandituriesPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ExpandituriesPageModel());
                  ...
                  Padding(
                    ...
                    child: StreamBuilder<List<SentMoneyForAllowenceRecord>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<SentMoneyForAllowenceRecord>
                            containerSentMoneyForAllowenceRecordList =
                            snapshot.data!;
