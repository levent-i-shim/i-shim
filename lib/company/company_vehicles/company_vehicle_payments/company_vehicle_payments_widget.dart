...
class CompanyVehiclePaymentsWidget extends StatefulWidget {
  const CompanyVehiclePaymentsWidget({
    super.key,
  ...
  static String routeName = 'CompanyVehiclePayments';
  static String routePath = '/companyVehiclePayments';

  @override
  State<CompanyVehiclePaymentsWidget> createState() =>
      _CompanyVehiclePaymentsWidgetState();
}

class _CompanyVehiclePaymentsWidgetState
    extends State<CompanyVehiclePaymentsWidget> {
  late CompanyVehiclePaymentsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CompanyVehiclePaymentsModel());
        ...
        body: SafeArea(
          ...
          child: StreamBuilder<List<CompanyVehiclePaymentsRecord>>(
            ...
            builder: (context, snapshot) {
              ...
              List<CompanyVehiclePaymentsRecord>
                  containerCompanyVehiclePaymentsRecordList = snapshot.data!;
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Builder(
                        builder: (context) {
                          final containerVar =
                              containerCompanyVehiclePaymentsRecordList
                                  .toList();
