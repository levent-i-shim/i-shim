...
class CompanyControlFinanceForPartnerPageWidget extends StatefulWidget {
  const CompanyControlFinanceForPartnerPageWidget({
    super.key,
  ...
  static String routeName = 'CompanyControlFinanceForPartnerPage';
  static String routePath = '/companyControlFinanceForPartnerPage';

  @override
  State<CompanyControlFinanceForPartnerPageWidget> createState() =>
      _CompanyControlFinanceForPartnerPageWidgetState();
}

class _CompanyControlFinanceForPartnerPageWidgetState
    extends State<CompanyControlFinanceForPartnerPageWidget> {
  late CompanyControlFinanceForPartnerPageModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => CompanyControlFinanceForPartnerPageModel());
                      ...
                      children: [
                            ...
                            onPressed: () async {
                              if (widget.partnership!.canViewIncomeExpenses) {
                                context.pushNamed(
                                  ...
                                  queryParameters: {
                                    'company': serializeParam(
                                      _model.companyDetail?.reference,
                                      ParamType.DocumentReference,
                                    ),
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            ...
                            text: 'Ödenmemiş Fatura Gelirleri',
                            options: FFButtonOptions(
                              width: double.infinity,
                              height: 40.0,
                              padding: EdgeInsetsDirectional.fromSTEB(
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            ...
                            text: 'Ödenmemiş Fatura Giderleri',
                            options: FFButtonOptions(
                              width: double.infinity,
                              height: 40.0,
                              padding: EdgeInsetsDirectional.fromSTEB(
