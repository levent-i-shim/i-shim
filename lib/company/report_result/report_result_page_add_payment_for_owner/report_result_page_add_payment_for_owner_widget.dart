...
class ReportResultPageAddPaymentForOwnerWidget extends StatefulWidget {
  const ReportResultPageAddPaymentForOwnerWidget({
    super.key,
  ...
  static String routeName = 'ReportResultPageAddPaymentForOwner';
  static String routePath = '/reportResultPageAddPaymentForOwner';

  @override
  State<ReportResultPageAddPaymentForOwnerWidget> createState() =>
      _ReportResultPageAddPaymentForOwnerWidgetState();
}

class _ReportResultPageAddPaymentForOwnerWidgetState
    extends State<ReportResultPageAddPaymentForOwnerWidget> {
  late ReportResultPageAddPaymentForOwnerModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => ReportResultPageAddPaymentForOwnerModel());
