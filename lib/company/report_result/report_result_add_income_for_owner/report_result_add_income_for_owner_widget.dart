...
class ReportResultAddIncomeForOwnerWidget extends StatefulWidget {
  const ReportResultAddIncomeForOwnerWidget({
    super.key,
  ...
  static String routeName = 'ReportResultAddIncomeForOwner';
  static String routePath = '/reportResultAddIncomeForOwner';

  @override
  State<ReportResultAddIncomeForOwnerWidget> createState() =>
      _ReportResultAddIncomeForOwnerWidgetState();
}

class _ReportResultAddIncomeForOwnerWidgetState
    extends State<ReportResultAddIncomeForOwnerWidget> {
  late ReportResultAddIncomeForOwnerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReportResultAddIncomeForOwnerModel());
