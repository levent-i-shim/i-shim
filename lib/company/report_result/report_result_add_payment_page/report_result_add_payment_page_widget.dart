...
class ReportResultAddPaymentPageWidget extends StatefulWidget {
  const ReportResultAddPaymentPageWidget({
    super.key,
    required this.value,
  ...
  static String routeName = 'ReportResultAddPaymentPage';
  static String routePath = '/reportResultAddPaymentPage';

  @override
  State<ReportResultAddPaymentPageWidget> createState() =>
      _ReportResultAddPaymentPageWidgetState();
}

class _ReportResultAddPaymentPageWidgetState
    extends State<ReportResultAddPaymentPageWidget> {
  late ReportResultAddPaymentPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReportResultAddPaymentPageModel());
