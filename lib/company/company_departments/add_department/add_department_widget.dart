...
class AddDepartmentWidget extends StatefulWidget {
  ...
  static String routeName = 'AddDepartment';
  static String routePath = '/addDepartment';
...
class _AddDepartmentWidgetState extends State<AddDepartmentWidget> {
  ...
  void initState() {
    ...
    _model.textFieldTypeTextController ??= TextEditingController();
                                      ...
                                      children: [
                                        ...
                                        Flexible(
                                          ...
                                          child: Container(
                                            ...
                                            child: TextFormField(
                                              controller: _model
                                                  .textFieldTypeTextController,
                                              focusNode:
                                                  _model.textFieldTypeFocusNode,
                                              autofocus: false,
                                              obscureText: false,
                                              decoration: InputDecoration(
                                                isDense: true,
                                              ...
                                              cursorColor:
                                                  FlutterFlowTheme.of(context)
                                                      .primaryText,
                                              validator: _model
                                                  .textFieldTypeTextControllerValidator
                                                  .asValidator(context),
                                            ),
                                          ),
                                        ),
                                  ...
                                  onPressed: () async {
                                    ...
                                    if (_model.validate!) {
                                      ...
                                      await workPlaceDepartmentRecordReference
                                        ...
                                        isDelete: false,
                                        type: _model
                                            .textFieldTypeTextController.text,
                                        createdBy: currentUserReference,
                                      ));
                                      _model.ref = WorkPlaceDepartmentRecord
                                          .getDocumentFromData(
                                              createWorkPlaceDepartmentRecordData(
                                                name:
