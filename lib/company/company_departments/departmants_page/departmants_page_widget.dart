...
class DepartmantsPageWidget extends StatefulWidget {
  const DepartmantsPageWidget({
    super.key,
    ...
    required this.canAddDepartmnet,
  });
  ...
  final bool? isOwner;
  final bool? canAddDepartmnet;

  static String routeName = 'DepartmantsPage';
  static String routePath = '/departmantsPage';

  @override
  State<DepartmantsPageWidget> createState() => _DepartmantsPageWidgetState();
}

class _DepartmantsPageWidgetState extends State<DepartmantsPageWidget> {
  late DepartmantsPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DepartmantsPageModel());
    ...
    return StreamBuilder<List<CompanyDepartmentsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CompanyDepartmentsRecord>
            departmantsPageCompanyDepartmentsRecordList = snapshot.data!;
                        ...
                        child: Builder(
                          builder: (context) {
                            final companyDepartments =
                                departmantsPageCompanyDepartmentsRecordList
                                    .toList();
                                ...
                                return Align(
                                  ...
                                  child: Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        context.pushNamed(
                                          DepartmentEmployessWidget.routeName,
                                          queryParameters: {
