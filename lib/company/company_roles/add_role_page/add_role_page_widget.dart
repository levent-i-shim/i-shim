...
class AddRolePageWidget extends StatefulWidget {
  const AddRolePageWidget({
    super.key,
  ...
  static String routeName = 'AddRolePage';
  static String routePath = '/addRolePage';

  @override
  State<AddRolePageWidget> createState() => _AddRolePageWidgetState();
}

class _AddRolePageWidgetState extends State<AddRolePageWidget> {
  late AddRolePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddRolePageModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      for (int loop1Index = 0;
        ...
        _model.addToRoles(currentLoop1Item);
        safeSetState(() {});
      }
    });
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      'Rol özelliği ile kullanıcılar için görev adları tanımlayarak ekip yapınızı düzenli şekilde oluşturabilirsiniz.',
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                ...
                                if (_model.validate!) {
                                  ...
                                  _model.ref =
                                      WorkPlaceRolesRecord.getDocumentFromData(
                                          createWorkPlaceRolesRecordData(
                                            name: _model.textController.text,
                                            isDelete: false,
                                            createdBy: currentUserReference,
                                          ),
                                          workPlaceRolesRecordReference);
                                  ...
                                  _model.companyRole =
                                      CompanyRolesRecord.getDocumentFromData(
