...
class TransactionDetailForDailyPageWidget extends StatefulWidget {
  const TransactionDetailForDailyPageWidget({
    super.key,
    required this.transaction,
    bool? isIncome,
    this.companyIncomeRef,
    this.companyPaymentsRed,
    bool? showStock,
    this.stockMovement,
  })  : this.isIncome = isIncome ?? true,
        this.showStock = showStock ?? false;

  final CompanyTransactionsRecord? transaction;
  final bool isIncome;
  final DocumentReference? companyIncomeRef;
  final DocumentReference? companyPaymentsRed;
  final bool showStock;
  final DocumentReference? stockMovement;

  static String routeName = 'TransactionDetailForDailyPage';
  static String routePath = '/transactionDetailForDailyPage';

  @override
  State<TransactionDetailForDailyPageWidget> createState() =>
      _TransactionDetailForDailyPageWidgetState();
}

class _TransactionDetailForDailyPageWidgetState
    extends State<TransactionDetailForDailyPageWidget> {
  late TransactionDetailForDailyPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TransactionDetailForDailyPageModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (widget.isIncome) {
        ...
        _model.value = _model.income?.value;
        _model.type = _model.income!.type;
        safeSetState(() {});
      } else {
        ...
        _model.value = _model.payment?.value;
        _model.type = _model.payment!.type;
        safeSetState(() {});
      }
    });
