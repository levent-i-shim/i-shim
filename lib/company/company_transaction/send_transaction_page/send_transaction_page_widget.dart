...
class SendTransactionPageWidget extends StatefulWidget {
  const SendTransactionPageWidget({
    super.key,
  ...
  static String routeName = 'SendTransactionPage';
  static String routePath = '/sendTransactionPage';

  @override
  State<SendTransactionPageWidget> createState() =>
      _SendTransactionPageWidgetState();
}

class _SendTransactionPageWidgetState extends State<SendTransactionPageWidget> {
  late SendTransactionPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SendTransactionPageModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<CompanyWorkersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CompanyWorkersRecord> sendTransactionPageCompanyWorkersRecordList =
            snapshot.data!;
          ...
          child: Scaffold(
            ...
            body: SafeArea(
              ...
              child: Container(
                ...
                child: Padding(
                  padding:
                      EdgeInsetsDirectional.fromSTEB(10.0, 36.0, 10.0, 10.0),
                  child: Container(
                    width: double.infinity,
                    decoration: BoxDecoration(
                        ...
                        children: [
                          ...
                          FlutterFlowDropDown<String>(
                            ...
                            options: List<String>.from(
                                sendTransactionPageCompanyWorkersRecordList
                                    .map((e) => e.userRef?.id)
                                    .withoutNulls
                                    .toList()),
                            optionLabels:
                            ...
                            hintText: 'Onaya Gönderilecek Kişi',
                            icon: Icon(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                ...
                                var workPlaceTransactionRecordReference =
                                    WorkPlaceTransactionRecord.createDoc(_model
                                        .workPlaceReports!.parentReference);
                                ...
                                await companyTransactionsRecordReference.set({
                                  ...createCompanyTransactionsRecordData(
                                    ...
                                    workPlaceTransaction:
                                        _model.transactionWorkPlace?.reference,
                                  ),
                                  ...mapToFirestore(
                                    {
                                      'date': FieldValue.serverTimestamp(),
                                ...
                                _model.transaction = CompanyTransactionsRecord
                                    .getDocumentFromData({
                                  ...createCompanyTransactionsRecordData(
                                    name: _model.textController1.text,
                                    description: _model.textController2.text,
                                ...
                                await AjandaRecord.createDoc(
                                  ...
                                  ...createAjandaRecordData(
                                    description: 'İşlem Onay İçin Gönderildi',
                                    type: WorkHistoryTypes.sendTransaction.name,
                                    transaction: _model.transaction?.reference,
                                    fullDescription:
                                        '${_model.transaction?.name} isimli işlem onaya gönderildi',
                                  ),
                                  ...mapToFirestore(
                                    {
