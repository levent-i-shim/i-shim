...
import 'company_unit_employees_model.dart';
export 'company_unit_employees_model.dart';

class CompanyUnitEmployeesWidget extends StatefulWidget {
  const CompanyUnitEmployeesWidget({
    super.key,
  ...
  final CompanyUnitsRecord? companyUnit;
  final bool? isOwner;
  ...
  static String routeName = 'CompanyUnitEmployees';
  static String routePath = '/companyUnitEmployees';

  @override
  State<CompanyUnitEmployeesWidget> createState() =>
      _CompanyUnitEmployeesWidgetState();
}

class _CompanyUnitEmployeesWidgetState
    extends State<CompanyUnitEmployeesWidget> {
  late CompanyUnitEmployeesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CompanyUnitEmployeesModel());
                      ...
                      stream: queryCompanyWorkersRecord(
                        ...
                        queryBuilder: (companyWorkersRecord) =>
                            companyWorkersRecord
                                .where(
                                  'unitRefs',
                                  arrayContains: widget!.companyUnit?.reference,
                                )
                                .where(
                                  'isDelete',
                                  isEqualTo: false,
