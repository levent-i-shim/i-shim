...
class CompanyUnitAddPageWidget extends StatefulWidget {
  const CompanyUnitAddPageWidget({
    super.key,
  ...
  static String routeName = 'CompanyUnitAddPage';
  static String routePath = '/companyUnitAddPage';

  @override
  State<CompanyUnitAddPageWidget> createState() =>
      _CompanyUnitAddPageWidgetState();
}

class _CompanyUnitAddPageWidgetState extends State<CompanyUnitAddPageWidget> {
  late CompanyUnitAddPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CompanyUnitAddPageModel());
    ...
    return StreamBuilder<List<CompanyDepartmentsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CompanyDepartmentsRecord>
            companyUnitAddPageCompanyDepartmentsRecordList = snapshot.data!;
                                          ...
                                          children: [
                                            ...
                                            Flexible(
                                              ...
                                              child:
                                                ...
                                                options: List<String>.from(
                                                    companyUnitAddPageCompanyDepartmentsRecordList
                                                        .map((e) =>
                                                            e.reference.id)
                                                        .toList()),
                                                optionLabels:
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      if (_model.validate!) {
                                        ...
                                        _model.ref = WorkPlaceUnitsRecord
                                            .getDocumentFromData(
                                        ...
                                        await companyUnitsRecordReference
                                          ...
                                          workplaceRef: _model.workPlaceRef,
                                          isDelete: false,
                                          workPlaceUnitRef:
                                              _model.ref?.reference,
                                          createdBy: currentUserReference,
                                        ));
                                        _model.companyUnit = CompanyUnitsRecord
                                            .getDocumentFromData(
