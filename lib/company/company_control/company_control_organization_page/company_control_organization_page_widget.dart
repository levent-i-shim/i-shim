...
class CompanyControlOrganizationPageWidget extends StatefulWidget {
  const CompanyControlOrganizationPageWidget({
    super.key,
    this.company,
  });
  ...
  static String routeName = 'CompanyControlOrganizationPage';
  static String routePath = '/companyControlOrganizationPage';

  @override
  State<CompanyControlOrganizationPageWidget> createState() =>
      _CompanyControlOrganizationPageWidgetState();
}

class _CompanyControlOrganizationPageWidgetState
    extends State<CompanyControlOrganizationPageWidget> {
  late CompanyControlOrganizationPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CompanyControlOrganizationPageModel());
