...
import 'dart:ui';
import 'company_partners_manage_page_widget.dart'
...
class CompanyPartnersManagePageModel
    extends FlutterFlowModel<CompanyPartnersManagePageWidget> {
  ///  State fields for stateful widgets in this page.

  // State field(s) for SwitchCanViewExpense widget.
  bool? switchCanViewExpenseValue;
  // State field(s) for SwitchCanAddManuelIncomeExpense widget.
  bool? switchCanAddManuelIncomeExpenseValue;
  // State field(s) for SwitchCanManageTransaction widget.
  bool? switchCanManageTransactionValue;
  // State field(s) for SwitchCanViewCurrentAccount widget.
  bool? switchCanViewCurrentAccountValue;
  // State field(s) for SwitchCanManageCurrentAccount widget.
  bool? switchCanManageCurrentAccountValue;
  ...
  // State field(s) for SwitchCanCreate widget.
  bool? switchCanCreateValue;
  ...
  // State field(s) for SwitchCanViewUsers widget.
  bool? switchCanViewUsersValue;
