...
class CompanyPartnersManagePageWidget extends StatefulWidget {
  const CompanyPartnersManagePageWidget({
    super.key,
    required this.partnership,
    required this.company,
  });

  final PartnershipsRecord? partnership;
  final CompaniesRecord? company;

  static String routeName = 'CompanyPartnersManagePage';
  static String routePath = '/companyPartnersManagePage';

  @override
  State<CompanyPartnersManagePageWidget> createState() =>
      _CompanyPartnersManagePageWidgetState();
}

class _CompanyPartnersManagePageWidgetState
    extends State<CompanyPartnersManagePageWidget> {
  late CompanyPartnersManagePageModel _model;
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Flexible(
                          flex: 2,
                          child: Switch.adaptive(
                            value: _model.switchCanAddManuelIncomeExpenseValue!,
                            onChanged: (newValue) async {
                              safeSetState(() =>
                                  _model.switchCanAddManuelIncomeExpenseValue =
                                      newValue);
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Flexible(
                          flex: 2,
                          child: Switch.adaptive(
                            value: _model.switchCanViewCurrentAccountValue!,
                            onChanged: (newValue) async {
                              safeSetState(() =>
                                  _model.switchCanViewCurrentAccountValue =
                                      newValue);
                    ...
                    Row(
                      ...
                      children: [
                        Flexible(
                          flex: 8,
                          child: Text(
                            'Cari Hesaplarda İşlem Yapabilme',
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                                  font: GoogleFonts.inter(
                        ...
                        Flexible(
                          flex: 2,
                          child: Switch.adaptive(
                            value: _model.switchCanManageCurrentAccountValue!,
                            onChanged: (newValue) async {
                              safeSetState(() =>
                                  _model.switchCanManageCurrentAccountValue =
                                      newValue);
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          await widget.partnership!.reference
                            ...
                            canCreateTasks: _model.switchCanCreateValue,
                            canManageTasks: _model.switchCanManageTaskValue,
                            ...
                            canViewVehicles: _model.switchCanViewVehiclesValue,
                            canManageWorkers: _model.switchCanManageUsersValue,
                            canManageVehicles:
                                _model.switchCanManageVehiclesValue,
                            ...
                            canManagePendingIncomeExpenses:
                                _model.switchCanManageTransactionValue,
                            canViewWorkers: _model.switchCanViewUsersValue,
