...
class CopmanyPartnershipsPageWidget extends StatefulWidget {
  const CopmanyPartnershipsPageWidget({
    super.key,
    required this.companyDetail,
  });

  final CompaniesRecord? companyDetail;

  static String routeName = 'CopmanyPartnershipsPage';
  static String routePath = '/copmanyPartnershipsPage';

  @override
  State<CopmanyPartnershipsPageWidget> createState() =>
      _CopmanyPartnershipsPageWidgetState();
}

class _CopmanyPartnershipsPageWidgetState
    extends State<CopmanyPartnershipsPageWidget> {
  late CopmanyPartnershipsPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CopmanyPartnershipsPageModel());
                      ...
                      child: Row(
                        ...
                        children: [
                          Flexible(
                            flex: 7,
                            child: Text(
                              'Şirketinize Yeni Bir Ortak Eklemek için Tıklayınız',
                        ...
                        itemBuilder: (context, partnerIndex) {
                          ...
                          return Padding(
                            ...
                            child: StreamBuilder<UsersRecord>(
                              stream: UsersRecord.getDocument(partnerItem),
                                  ...
                                  child: Padding(
                                    ...
                                    child:
                                      ...
                                      stream: queryPartnershipsRecord(
                                        ...
                                        queryBuilder: (partnershipsRecord) =>
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        final containerPartnershipsRecord =
                                            containerPartnershipsRecordList
                                                    .isNotEmpty
                                                ? containerPartnershipsRecordList
                                                    .first
                                        ...
                                        return InkWell(
                                          ...
                                          onTap: () async {
                                            context.pushNamed(
                                              CompanyPartnersManagePageWidget
                                                  .routeName,
                                              queryParameters: {
