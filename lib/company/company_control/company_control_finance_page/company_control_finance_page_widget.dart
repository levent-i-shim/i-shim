...
class CompanyControlFinancePageWidget extends StatefulWidget {
  const CompanyControlFinancePageWidget({
    super.key,
  ...
  static String routeName = 'CompanyControlFinancePage';
  static String routePath = '/companyControlFinancePage';

  @override
  State<CompanyControlFinancePageWidget> createState() =>
      _CompanyControlFinancePageWidgetState();
}

class _CompanyControlFinancePageWidgetState
    extends State<CompanyControlFinancePageWidget> {
  late CompanyControlFinancePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CompanyControlFinancePageModel());
