...
class AddPartnerCompanyStep2PageWidget extends StatefulWidget {
  const AddPartnerCompanyStep2PageWidget({
    super.key,
  ...
  static String routeName = 'AddPartnerCompanyStep2Page';
  static String routePath = '/addPartnerCompanyStep2Page';

  @override
  State<AddPartnerCompanyStep2PageWidget> createState() =>
      _AddPartnerCompanyStep2PageWidgetState();
}

class _AddPartnerCompanyStep2PageWidgetState
    extends State<AddPartnerCompanyStep2PageWidget> {
  late AddPartnerCompanyStep2PageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddPartnerCompanyStep2PageModel());
                      ...
                      onPressed: () async {
                        if (widget!.user?.reference == currentUserReference) {
                          ...
                          _model.partnershipInvitation =
                              PartnershipInvitationRecord.getDocumentFromData({
                            ...createPartnershipInvitationRecordData(
                              isCompanyPartnership: true,
                              isAccept: false,
                              isReject: false,
