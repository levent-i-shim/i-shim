...
export 'incomes_page_model.dart';

class IncomesPageWidget extends StatefulWidget {
  const IncomesPageWidget({
    super.key,
  ...
  static String routeName = 'IncomesPage';
  static String routePath = '/incomesPage';
...
class _IncomesPageWidgetState extends State<IncomesPageWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => IncomesPageModel());
              ...
              FFButtonWidget(
                onPressed: () async {
                  if (widget.canAddIncome!) {
                    context.pushNamed(
                      AddManualIncomePageWidget.routeName,
                      queryParameters: {
