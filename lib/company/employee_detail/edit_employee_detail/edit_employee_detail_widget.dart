...
class EditEmployeeDetailWidget extends StatefulWidget {
  const EditEmployeeDetailWidget({
    super.key,
    required this.company,
    required this.copmanyWorker,
    required this.workPlaceIds,
    required this.myWorkedWorkPlace,
    required this.canManageWorker,
  });

  final DocumentReference? company;
  final CompanyWorkersRecord? copmanyWorker;
  final List<DocumentReference>? workPlaceIds;
  final DocumentReference? myWorkedWorkPlace;
  final bool? canManageWorker;

  static String routeName = 'EditEmployeeDetail';
  static String routePath = '/editEmployeeDetail';

  @override
  State<EditEmployeeDetailWidget> createState() =>
      _EditEmployeeDetailWidgetState();
}

class _EditEmployeeDetailWidgetState extends State<EditEmployeeDetailWidget> {
  late EditEmployeeDetailModel _model;
    ...
    return StreamBuilder<List<CompanyDepartmentsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CompanyDepartmentsRecord>
            editEmployeeDetailCompanyDepartmentsRecordList = snapshot.data!;
            ...
            body: SafeArea(
              ...
              child: StreamBuilder<List<CompanyRolesRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  List<CompanyRolesRecord> containerCompanyRolesRecordList =
                      snapshot.data!;
                            ...
                            child: StreamBuilder<List<CompanyUnitsRecord>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<CompanyUnitsRecord>
                                    containerCompanyUnitsRecordList =
                                    snapshot.data!;
                                                ...
                                                children: [
                                                  ...
                                                  FlutterFlowDropDown<String>(
                                                    ...
                                                    options: List<String>.from(
                                                        editEmployeeDetailCompanyDepartmentsRecordList
                                                            .map((e) =>
                                                                e.reference.id)
                                                            .toList()),
                                                    optionLabels:
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    FlutterFlowDropDown<String>(
                                                      ...
                                                      options: List<
                                                              String>.from(
                                                          containerCompanyRolesRecordList
                                                              .map((e) => e
                                                                  .reference.id)
                                                              .toList()),
                                                      optionLabels:
                                        ...
                                        Padding(
                                          ...
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              ...
                                              _model.newUnitRefs = [];
                                              _model.selectedWorkPlaces = [];
                                              _model.addToNewRoleRefs(
                                                  _model.newRole!);
                                              _model.addToNewDepartmentRefs(
                                                  _model.newDepartment!);
                                              ...
                                              for (int loop1Index = 0;
                                                ...
                                                _model.addToSelectedWorkPlaces(
                                                    _model.workPlace!);
                                              }
