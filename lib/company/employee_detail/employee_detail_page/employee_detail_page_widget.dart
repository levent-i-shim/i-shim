...
class EmployeeDetailPageWidget extends StatefulWidget {
  const EmployeeDetailPageWidget({
    super.key,
  ...
  static String routeName = 'EmployeeDetailPage';
  static String routePath = '/employeeDetailPage';

  @override
  State<EmployeeDetailPageWidget> createState() =>
      _EmployeeDetailPageWidgetState();
}

class _EmployeeDetailPageWidgetState extends State<EmployeeDetailPageWidget> {
  late EmployeeDetailPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EmployeeDetailPageModel());
                  ...
                  children: [
                              ...
                              children: [
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      5.0, 5.0, 0.0, 0.0),
                                  child: Text(
                                    'Harcama Yapabilmek için Kalan Parası',
                    ...
                    StreamBuilder<List<SpentMoneyForAllowenceRecord>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<SpentMoneyForAllowenceRecord>
                            containerSpentMoneyForAllowenceRecordList =
                            snapshot.data!;
                          ...
                          child: Builder(
                            builder: (context) {
                              ...
                              return ListView.builder(
                                ...
                                itemBuilder: (context, spentIndex) {
                                  final spentItem = spent[spentIndex];
                                  return Container(
                                    width: 100.0,
                                    height: 100.0,
                                    decoration: BoxDecoration(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        FFButtonWidget(
                                          onPressed: () async {
                                            context.pushNamed(
                                              SpendExpandituryDetailPageWidget
                                                  .routeName,
                                              queryParameters: {
