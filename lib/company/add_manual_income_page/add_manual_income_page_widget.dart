...
import 'add_manual_income_page_model.dart';
export 'add_manual_income_page_model.dart';

class AddManualIncomePageWidget extends StatefulWidget {
  const AddManualIncomePageWidget({
    super.key,
  ...
  final CompanyIncomes2025Record? companyIncome;
  final bool? isEdit;

  static String routeName = 'AddManualIncomePage';
  static String routePath = '/addManualIncomePage';

  @override
  State<AddManualIncomePageWidget> createState() =>
      _AddManualIncomePageWidgetState();
}

class _AddManualIncomePageWidgetState extends State<AddManualIncomePageWidget> {
  late AddManualIncomePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddManualIncomePageModel());
      ...
      if (widget.isEdit!) {
        ...
        safeSetState(() {
          _model.dropDownWorkPlaceValueController?.value =
              widget.companyIncome!.workPlace!.id;
          _model.dropDownWorkPlaceValue = widget.companyIncome!.workPlace!.id;
        });
      }
    });
                        ...
                        if (widget.isEdit!) {
                          ...
                          await workPlaceIncomes2025RecordReference.set({
                            ...createWorkPlaceIncomes2025RecordData(
                              ...
                              type: _model.dropDownTypeValue,
                              fromWhom: _model
                                  .textFieldGelirKaynakTextController.text,
                              description: _model
