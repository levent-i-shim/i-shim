...
import 'company_tasks_for_duty_create_page_model.dart';
export 'company_tasks_for_duty_create_page_model.dart';

class CompanyTasksForDutyCreatePageWidget extends StatefulWidget {
  const CompanyTasksForDutyCreatePageWidget({
    super.key,
  ...
  static String routeName = 'CompanyTasksForDutyCreatePage';
  static String routePath = '/companyTasksForDutyCreatePage';

  @override
  State<CompanyTasksForDutyCreatePageWidget> createState() =>
      _CompanyTasksForDutyCreatePageWidgetState();
}

class _CompanyTasksForDutyCreatePageWidgetState
    extends State<CompanyTasksForDutyCreatePageWidget> {
  late CompanyTasksForDutyCreatePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CompanyTasksForDutyCreatePageModel());
