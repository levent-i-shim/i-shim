...
class CompanyTaskDutiesReadReportPageWidget extends StatefulWidget {
  const CompanyTaskDutiesReadReportPageWidget({
    super.key,
  ...
  static String routeName = 'CompanyTaskDutiesReadReportPage';
  static String routePath = '/companyTaskDutiesReadReportPage';

  @override
  State<CompanyTaskDutiesReadReportPageWidget> createState() =>
      _CompanyTaskDutiesReadReportPageWidgetState();
}

class _CompanyTaskDutiesReadReportPageWidgetState
    extends State<CompanyTaskDutiesReadReportPageWidget> {
  late CompanyTaskDutiesReadReportPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CompanyTaskDutiesReadReportPageModel());
    ...
    return StreamBuilder<List<CompanyReportsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CompanyReportsRecord>
            companyTaskDutiesReadReportPageCompanyReportsRecordList =
            snapshot.data!;
