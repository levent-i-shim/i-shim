...
class UpdateCompanyNotePageWidget extends StatefulWidget {
  const UpdateCompanyNotePageWidget({
    super.key,
  ...
  static String routeName = 'UpdateCompanyNotePage';
  static String routePath = '/updateCompanyNotePage';

  @override
  State<UpdateCompanyNotePageWidget> createState() =>
      _UpdateCompanyNotePageWidgetState();
}

class _UpdateCompanyNotePageWidgetState
    extends State<UpdateCompanyNotePageWidget> {
  late UpdateCompanyNotePageModel _model;
