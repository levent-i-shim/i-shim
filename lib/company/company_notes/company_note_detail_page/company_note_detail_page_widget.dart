...
class CompanyNoteDetailPageWidget extends StatefulWidget {
  const CompanyNoteDetailPageWidget({
    super.key,
    required this.companyNote,
    required this.canManage,
  });

  final CompanyNotesRecord? companyNote;
  final bool? canManage;

  static String routeName = 'CompanyNoteDetailPage';
  static String routePath = '/companyNoteDetailPage';

  @override
  State<CompanyNoteDetailPageWidget> createState() =>
      _CompanyNoteDetailPageWidgetState();
}

class _CompanyNoteDetailPageWidgetState
    extends State<CompanyNoteDetailPageWidget> {
  late CompanyNoteDetailPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CompanyNoteDetailPageModel());
