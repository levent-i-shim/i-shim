...
class AddNewCompanyNotePageWidget extends StatefulWidget {
  const AddNewCompanyNotePageWidget({
    super.key,
    required this.company,
    required this.hasCompanyRecord,
    required this.hasMachineFailure,
    required this.hasPersonnelNote,
    required this.hasFinancialNote,
    required this.hasTaxNote,
  });

  final DocumentReference? company;
  final bool? hasCompanyRecord;
  final bool? hasMachineFailure;
  final bool? hasPersonnelNote;
  final bool? hasFinancialNote;
  final bool? hasTaxNote;

  static String routeName = 'AddNewCompanyNotePage';
  static String routePath = '/addNewCompanyNotePage';

  @override
  State<AddNewCompanyNotePageWidget> createState() =>
      _AddNewCompanyNotePageWidgetState();
}

class _AddNewCompanyNotePageWidgetState
    extends State<AddNewCompanyNotePageWidget> {
  late AddNewCompanyNotePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddNewCompanyNotePageModel());
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    ...
                    if (_model.validate!) {
                      ...
                      _model.addedNote =
                          CompanyNotesRecord.getDocumentFromData({
                        ...createCompanyNotesRecordData(
                          title: _model.textFieldTitleTextController.text,
                          content: _model.textFieldContentTextController.text,
                          isDelete: false,
