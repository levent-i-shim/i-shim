...
class CompanyTaskReadReportsPageWidget extends StatefulWidget {
  const CompanyTaskReadReportsPageWidget({
    super.key,
    required this.task,
    bool? isPartner,
    bool? canManage,
  ...
  static String routeName = 'CompanyTaskReadReportsPage';
  static String routePath = '/companyTaskReadReportsPage';

  @override
  State<CompanyTaskReadReportsPageWidget> createState() =>
      _CompanyTaskReadReportsPageWidgetState();
}

class _CompanyTaskReadReportsPageWidgetState
    extends State<CompanyTaskReadReportsPageWidget> {
  late CompanyTaskReadReportsPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CompanyTaskReadReportsPageModel());
                      ...
                      child: StreamBuilder<List<CompanyReportsRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<CompanyReportsRecord>
                              listViewCompanyReportsRecordList = snapshot.data!;

                          return ListView.builder(
                            padding: EdgeInsets.zero,
                            shrinkWrap: true,
                            scrollDirection: Axis.vertical,
                            itemCount: listViewCompanyReportsRecordList.length,
