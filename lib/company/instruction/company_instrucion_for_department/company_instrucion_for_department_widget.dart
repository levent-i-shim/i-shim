...
import 'company_instrucion_for_department_model.dart';
export 'company_instrucion_for_department_model.dart';

class CompanyInstrucionForDepartmentWidget extends StatefulWidget {
  const CompanyInstrucionForDepartmentWidget({
    super.key,
  ...
  static String routeName = 'CompanyInstrucionForDepartment';
  static String routePath = '/companyInstrucionForDepartment';

  @override
  State<CompanyInstrucionForDepartmentWidget> createState() =>
      _CompanyInstrucionForDepartmentWidgetState();
}

class _CompanyInstrucionForDepartmentWidgetState
    extends State<CompanyInstrucionForDepartmentWidget> {
  late CompanyInstrucionForDepartmentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CompanyInstrucionForDepartmentModel());
    ...
    return StreamBuilder<List<CompanyDepartmentsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CompanyDepartmentsRecord>
            companyInstrucionForDepartmentCompanyDepartmentsRecordList =
            snapshot.data!;
