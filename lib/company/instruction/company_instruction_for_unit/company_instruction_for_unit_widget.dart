...
import 'company_instruction_for_unit_model.dart';
export 'company_instruction_for_unit_model.dart';

class CompanyInstructionForUnitWidget extends StatefulWidget {
  const CompanyInstructionForUnitWidget({
    super.key,
  ...
  static String routeName = 'CompanyInstructionForUnit';
  static String routePath = '/companyInstructionForUnit';

  @override
  State<CompanyInstructionForUnitWidget> createState() =>
      _CompanyInstructionForUnitWidgetState();
}

class _CompanyInstructionForUnitWidgetState
    extends State<CompanyInstructionForUnitWidget> {
  late CompanyInstructionForUnitModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CompanyInstructionForUnitModel());
    ...
    return StreamBuilder<List<CompanyUnitsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CompanyUnitsRecord>
            companyInstructionForUnitCompanyUnitsRecordList = snapshot.data!;
                        ...
                        children: [
                          ...
                          FlutterFlowDropDown<String>(
                            ...
                            options: List<String>.from(
                                companyInstructionForUnitCompanyUnitsRecordList
                          ...
                          Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                ...
                                if (_model.validate!) {
                                  _model.unitRef = await actions.getUnitDocRef(
                                    _model.dropDownValue!,
                                    widget.company!.id,
                                  );
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text(
                                        'Bu Rolde Çalışanlara Gönderildi',
                                        style: TextStyle(
