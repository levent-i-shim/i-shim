...
class CompanyInstructionsCreatePageWidget extends StatefulWidget {
  const CompanyInstructionsCreatePageWidget({
    super.key,
  ...
  static String routeName = 'CompanyInstructionsCreatePage';
  static String routePath = '/companyInstructionsCreatePage';

  @override
  State<CompanyInstructionsCreatePageWidget> createState() =>
      _CompanyInstructionsCreatePageWidgetState();
}

class _CompanyInstructionsCreatePageWidgetState
    extends State<CompanyInstructionsCreatePageWidget> {
  late CompanyInstructionsCreatePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CompanyInstructionsCreatePageModel());
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(48.0, 24.0, 48.0, 0.0),
                    child: Container(
                      width: double.infinity,
                      decoration: BoxDecoration(),
                      child: Align(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    context.pushNamed(
                                      CompanyInstrucionForDepartmentWidget
                                          .routeName,
                                      queryParameters: {
                                        'company': serializeParam(
                                          widget!.company,
                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    context.pushNamed(
                                      CompanyInstructionsForRoleWidget
                                          .routeName,
                                      queryParameters: {
                                        'company': serializeParam(
                                          widget!.company,
                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    context.pushNamed(
                                      CompanyInstructionForPersonWidget
                                          .routeName,
                                      queryParameters: {
                                        'company': serializeParam(
                                          widget!.company,
