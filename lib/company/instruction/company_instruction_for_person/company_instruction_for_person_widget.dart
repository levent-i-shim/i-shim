...
class CompanyInstructionForPersonWidget extends StatefulWidget {
  const CompanyInstructionForPersonWidget({
    super.key,
  ...
  static String routeName = 'CompanyInstructionForPerson';
  static String routePath = '/companyInstructionForPerson';

  @override
  State<CompanyInstructionForPersonWidget> createState() =>
      _CompanyInstructionForPersonWidgetState();
}

class _CompanyInstructionForPersonWidgetState
    extends State<CompanyInstructionForPersonWidget> {
  late CompanyInstructionForPersonModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CompanyInstructionForPersonModel());
    ...
    return StreamBuilder<List<CompanyWorkersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CompanyWorkersRecord>
            companyInstructionForPersonCompanyWorkersRecordList =
            snapshot.data!;
