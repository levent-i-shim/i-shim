...
class CompanyInstructionsForRoleWidget extends StatefulWidget {
  const CompanyInstructionsForRoleWidget({
    super.key,
  ...
  static String routeName = 'companyInstructionsForRole';
  static String routePath = '/companyInstructionsForRole';

  @override
  State<CompanyInstructionsForRoleWidget> createState() =>
      _CompanyInstructionsForRoleWidgetState();
}

class _CompanyInstructionsForRoleWidgetState
    extends State<CompanyInstructionsForRoleWidget> {
  late CompanyInstructionsForRoleModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CompanyInstructionsForRoleModel());
    ...
    return StreamBuilder<List<CompanyRolesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CompanyRolesRecord>
            companyInstructionsForRoleCompanyRolesRecordList = snapshot.data!;
                        ...
                        children: [
                          ...
                          FlutterFlowDropDown<String>(
                            ...
                            options: List<String>.from(
                                companyInstructionsForRoleCompanyRolesRecordList
