...
class UpdateProductPageWidget extends StatefulWidget {
  ...
  static String routeName = 'UpdateProductPage';
  static String routePath = '/updateProductPage';

  @override
  State<UpdateProductPageWidget> createState() =>
...
class _UpdateProductPageWidgetState extends State<UpdateProductPageWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.fields = _model.allFields!.toList().cast<ProductFieldsRecord>();
      safeSetState(() {});
    });
              ...
              child: FFButtonWidget(
                onPressed: () async {
                  ...
                  if (_model.formKey1.currentState == null ||
                    ...
                    safeSetState(() => _model.validateCopy = false);
                    return;
                  }
                ...
                Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                        padding:
                            EdgeInsetsDirectional.fromSTEB(4.0, 24.0, 0.0, 0.0),
                        child: Text(
                          'Maliyet Öğesi',
                          style:
                              FlutterFlowTheme.of(context).bodyMedium.override(
