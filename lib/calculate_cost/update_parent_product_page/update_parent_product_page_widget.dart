...
class UpdateParentProductPageWidget extends StatefulWidget {
  const UpdateParentProductPageWidget({
    super.key,
    required this.product,
  });

  final ParentProductsRecord? product;

  static String routeName = 'UpdateParentProductPage';
  static String routePath = '/UpdateParentProductPage';

  @override
  State<UpdateParentProductPageWidget> createState() =>
      _UpdateParentProductPageWidgetState();
}

class _UpdateParentProductPageWidgetState
    extends State<UpdateParentProductPageWidget> {
  late UpdateParentProductPageModel _model;
