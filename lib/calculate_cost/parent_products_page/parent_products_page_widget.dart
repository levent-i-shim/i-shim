...
class ParentProductsPageWidget extends StatefulWidget {
  const ParentProductsPageWidget({
    super.key,
  ...
  static String routeName = 'ParentProductsPage';
  static String routePath = '/parentProductsPage';

  @override
  State<ParentProductsPageWidget> createState() =>
      _ParentProductsPageWidgetState();
}

class _ParentProductsPageWidgetState extends State<ParentProductsPageWidget>
    with TickerProviderStateMixin {
  late ParentProductsPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ParentProductsPageModel());
              ...
              children: [
                Align(
                  ...
                  child: TabBar(
                    ...
                    unselectedLabelColor: Color(0xA257636C),
                    labelStyle:
                    ...
                    children: [
                      StreamBuilder<List<ParentProductsRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<ParentProductsRecord>
                              listViewParentProductsRecordList = snapshot.data!;

                          return ListView.builder(
                            padding: EdgeInsets.zero,
                            scrollDirection: Axis.vertical,
                            itemCount: listViewParentProductsRecordList.length,
                            itemBuilder: (context, listViewIndex) {
                              final listViewParentProductsRecord =
                                  listViewParentProductsRecordList[
                                      listViewIndex];
                              return Padding(
                                                                  ...
                                                                  DeletionRequestRecord
                                                                      .getDocumentFromData(
                                                                          createDeletionRequestRecordData(
                                                                            ...
                                                                            parentProduct:
                                                                                listViewParentProductsRecord.reference,
                                                                            description:
                                                                                _model.description,
                                                                            triggeredUser:
                                                                                currentUserReference,
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 4.0, 0.0, 0.0),
                                            child: Text(
                                              listViewParentProductsRecord.name,
                                                          ...
                                                          child: Text(
                                                            ...
                                                            style: FlutterFlowTheme
                                                                ...
                                                                .override(
                                                                  ...
                                                                  color: (listViewParentProductsRecord.totalSoldCost -
                                                                              (listViewParentProductsRecord
                                                                                  .totalCost)) <
                                                                          0.0
                                                                      ? Color(
