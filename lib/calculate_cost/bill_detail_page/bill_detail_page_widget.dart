...
class BillDetailPageWidget extends StatefulWidget {
  const BillDetailPageWidget({
    super.key,
    required this.bill,
  ...
  final CurrentAccountRecord? currentAccount;

  static String routeName = 'BillDetailPage';
  static String routePath = '/billDetailPage';

  @override
  State<BillDetailPageWidget> createState() => _BillDetailPageWidgetState();
}

class _BillDetailPageWidgetState extends State<BillDetailPageWidget> {
  late BillDetailPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BillDetailPageModel());
