...
import 'sub_contractor_page_model.dart';
export 'sub_contractor_page_model.dart';

class SubContractorPageWidget extends StatefulWidget {
  const SubContractorPageWidget({super.key});

  static String routeName = 'subContractorPage';
  static String routePath = '/subContractorPage';

  @override
  State<SubContractorPageWidget> createState() =>
      _SubContractorPageWidgetState();
}

class _SubContractorPageWidgetState extends State<SubContractorPageWidget> {
  late SubContractorPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SubContractorPageModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<CompaniesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CompaniesRecord> subContractorPageCompaniesRecordList =
            snapshot.data!;
                              ...
                              SingleChildScrollView(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    if (subContractorPageCompaniesRecordList
                                            .length >=
                                        1)
                                      Padding(
                                        padding: EdgeInsets.all(8.0),
                                                  ...
                                                  children: [
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: Builder(
                                                        builder: (context) {
                                                          final profileVar =
                                                              subContractorPageCompaniesRecordList
                                                                  .toList();
