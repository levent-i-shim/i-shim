...
import '/index.dart';
import 'create_task_step6_for_single_task_widget.dart'
    show CreateTaskStep6ForSingleTaskWidget;
import 'package:flutter/material.dart';

class CreateTaskStep6ForSingleTaskModel
    extends FlutterFlowModel<CreateTaskStep6ForSingleTaskWidget> {
  ...
  String? _textController2Validator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return 'Görev Açıklaması Giriniz is required';
    }
