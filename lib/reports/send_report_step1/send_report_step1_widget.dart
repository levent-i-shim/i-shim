...
import 'send_report_step1_model.dart';
export 'send_report_step1_model.dart';

class SendReportStep1Widget extends StatefulWidget {
  const SendReportStep1Widget({super.key});

  static String routeName = 'SendReportStep1';
  static String routePath = '/sendReportStep1';

  @override
  State<SendReportStep1Widget> createState() => _SendReportStep1WidgetState();
}

class _SendReportStep1WidgetState extends State<SendReportStep1Widget> {
  late SendReportStep1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SendReportStep1Model());
                                      ...
                                      context.pushNamed(
                                        ...
                                        queryParameters: {
                                          ...
                                          'createdUserRef': serializeParam(
                                            containerVarItem.createdUserRef,
                                ...
                                return GridView.builder(
                                  ...
                                  itemBuilder: (context, companyIndex) {
                                    ...
                                    return InkWell(
                                      ...
                                      onTap: () async {
                                        context.pushNamed(
                                          SendReportStep2Widget.routeName,
                                          queryParameters: {
