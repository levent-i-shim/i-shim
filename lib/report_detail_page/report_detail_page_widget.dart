...
class ReportDetailPageWidget extends StatefulWidget {
  const ReportDetailPageWidget({
    super.key,
  ...
  static String routeName = 'ReportDetailPage';
  static String routePath = '/reportDetailPage';

  @override
  State<ReportDetailPageWidget> createState() => _ReportDetailPageWidgetState();
}

class _ReportDetailPageWidgetState extends State<ReportDetailPageWidget> {
  late ReportDetailPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReportDetailPageModel());
                ...
                var confirmDialogResponse = await showDialog<bool>(
                      ...
                      builder: (alertDialogContext) {
                        return AlertDialog(
                          ...
                          content: Text(
                              'Bu Raporu Silmek İstediğinize emin misiniz?'),
                          actions: [
                            TextButton(
                              onPressed: () =>
            ...
            child: Column(
              ...
              children: [
                ...
                Align(
                  ...
                  child: Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(14.0, 24.0, 0.0, 0.0),
                    child: Text(
                      'Rapor Detay',
                            ...
                            builder: (context) {
                              ...
                              return ListView.builder(
                                ...
                                itemBuilder: (context, fieldsIndex) {
                                  ...
                                  return Padding(
                                    padding: EdgeInsets.all(12.0),
                                    child: StreamBuilder<FormResponsesRecord>(
