...
import '/finance_notes/options_payment_note_company/options_payment_note_company_widget.dart';
...
class PaymentOrCollectionCashWidget extends StatefulWidget {
  const PaymentOrCollectionCashWidget({super.key});

  static String routeName = 'paymentOrCollectionCash';
  static String routePath = '/paymentOrCollectionCash';

  @override
  State<PaymentOrCollectionCashWidget> createState() =>
      _PaymentOrCollectionCashWidgetState();
}

class _PaymentOrCollectionCashWidgetState
    extends State<PaymentOrCollectionCashWidget> with TickerProviderStateMixin {
  late PaymentOrCollectionCashModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PaymentOrCollectionCashModel());
                    ...
                    SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                                ...
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        context.pushNamed(
                                            PaymentOrCollectionCashTableWidget
                                                .routeName);
                              ...
                              builder: (context, snapshot) {
                                ...
                                return FlutterFlowDropDown<String>(
                                  ...
                                  onChanged: (val) async {
                                    ...
                                    safeSetState(() {});
                                    _model.cashIncomeListToGetValues =
                                        await queryFinancialNoteCompanyRecordOnce(
                                      parent: _model.companyRefFromDD,
                                      queryBuilder:
                                          (financialNoteCompanyRecord) =>
                                    ...
                                    _model.cashIncomeCompanyToCount =
                                        await queryFinancialNoteCompanyRecordCount(
                                      parent: _model.companyRefFromDD,
                                      queryBuilder:
                                          (financialNoteCompanyRecord) =>
                          ...
                          StreamBuilder<List<FinancialNoteCompanyRecord>>(
                            stream: queryFinancialNoteCompanyRecord(
                              queryBuilder: (financialNoteCompanyRecord) =>
                                  financialNoteCompanyRecord
                                      .where(
                                        'companyRef',
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<FinancialNoteCompanyRecord>
                                  listViewFinancialNoteCompanyRecordList =
                                  snapshot.data!;
                              ...
                              return ListView.builder(
                                ...
                                itemBuilder: (context, listViewIndex) {
                                  final listViewFinancialNoteCompanyRecord =
                                      listViewFinancialNoteCompanyRecordList[
                                          listViewIndex];
                                  return Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        context.pushNamed(
                                          PaymentOrCollectionDetailWidget
                                              .routeName,
                                          queryParameters: {
                                                              ...
                                                              padding:
                                                                  EdgeInsetsDirectional
                                                                      .fromSTEB(
                                                                          ...
                                                                          2.0),
                                                              child: Text(
                                                                '${listViewFinancialNoteCompanyRecord.companyName}',
                                                                textAlign:
                                                                    TextAlign
                                                                        .start,
                                                                style: FlutterFlowTheme.of(
                                                          ...
                                                          padding:
                                                              EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      2.0),
                                                          child: Text(
                                                            '${listViewFinancialNoteCompanyRecord.workPlaceName}',
                                                            textAlign:
                                                                TextAlign.start,
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                          ...
                                                          padding:
                                                              EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      2.0),
                                                          child: Text(
                                                            '${listViewFinancialNoteCompanyRecord.incomeOrExpense}',
                                                            textAlign:
                                                                TextAlign.start,
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                            ...
                                                            padding:
                                                                EdgeInsetsDirectional
                                                                    .fromSTEB(
                                                                        ...
                                                                        2.0),
                                                            child: Text(
                                                              '${listViewFinancialNoteCompanyRecord.paidToWhomUserName}',
                                                              textAlign:
                                                                  TextAlign
                                                                      .start,
                                                              style: FlutterFlowTheme
                                                            ...
                                                            padding:
                                                                EdgeInsetsDirectional
                                                                    .fromSTEB(
                                                                        ...
                                                                        2.0),
                                                            child: Text(
                                                              '${listViewFinancialNoteCompanyRecord.collectedFromWhomUserName}',
                                                              textAlign:
                                                                  TextAlign
                                                                      .start,
                                                              style: FlutterFlowTheme
                                                      ...
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          ...
                                                          Padding(
                                                            ...
                                                            child: SelectionArea(
                                                                child: AutoSizeText(
                                                              '${listViewFinancialNoteCompanyRecord.content}',
                                                              textAlign:
                                                                  TextAlign
                                                                      .justify,
                                                              maxLines: 10,
                                                                ...
                                                                child: Align(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                        ...
                                                                        await Navigator
                                                                          ...
                                                                          PageTransition(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              image: Image.network(
                                                                                listViewFinancialNoteCompanyRecord.imageUrl,
                                                                                fit: BoxFit.contain,
                                                                              ),
                                                                              allowRotation: false,
                                                                              tag: listViewFinancialNoteCompanyRecord.imageUrl,
                                                                      ...
                                                                      child:
                                                                          Hero(
                                                                        tag: listViewFinancialNoteCompanyRecord
                                                                            .imageUrl,
                                                                ...
                                                                padding:
                                                                    EdgeInsetsDirectional
                                                                        .fromSTEB(
                                                                            ...
                                                                            0.0),
                                                                child: Text(
                                                                  '${listViewFinancialNoteCompanyRecord.creatorName}',
                                                                  textAlign:
                                                                      TextAlign
                                                                          .start,
                                                                  style: FlutterFlowTheme.of(
                                                            ...
                                                            padding:
                                                                EdgeInsetsDirectional
                                                                    .fromSTEB(
                                                                        ...
                                                                        4.0),
                                                            child: Text(
                                                              'Kayıt tarihi :  ${dateTimeFormat("d/M/y", listViewFinancialNoteCompanyRecord.creationDate)}',
                                                              style: FlutterFlowTheme
                                                                      .of(context)
                                                                  .bodyMedium
                                                                  .override(
                                                                  ...
                                                                  Padding(
                                                                    padding: EdgeInsetsDirectional
                                                                        .fromSTEB(
                                                                            ...
                                                                            2.0),
                                                                    child: Text(
                                                                      '${listViewFinancialNoteCompanyRecord.reference.id}',
                                                                      style: FlutterFlowTheme.of(
                                                                              context)
                                                                          .bodyMedium
                                                                          .override(
                                                                ...
                                                                builder:
                                                                  ...
                                                                  return Material(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                          OptionsPaymentNoteCompanyWidget(
                                                                        noteFinanceCompany:
                                                                            listViewFinancialNoteCompanyRecord,
                                                                      ),
                                                                    ),
