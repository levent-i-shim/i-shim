...
import 'check_payment_table_model.dart';
export 'check_payment_table_model.dart';

class CheckPaymentTableWidget extends StatefulWidget {
  const CheckPaymentTableWidget({
    super.key,
  ...
  static String routeName = 'checkPaymentTable';
  static String routePath = '/checkPaymentTable';

  @override
  State<CheckPaymentTableWidget> createState() =>
      _CheckPaymentTableWidgetState();
}

class _CheckPaymentTableWidgetState extends State<CheckPaymentTableWidget> {
  late CheckPaymentTableModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CheckPaymentTableModel());
