...
import 'update_payment_company_model.dart';
export 'update_payment_company_model.dart';

class UpdatePaymentCompanyWidget extends StatefulWidget {
  const UpdatePaymentCompanyWidget({
    super.key,
    required this.isEdit,
    required this.companyPaymentDoc,
  });

  final bool? isEdit;
  final FinancialNoteCompanyRecord? companyPaymentDoc;

  static String routeName = 'updatePaymentCompany';
  static String routePath = '/updatePaymentCompany';

  @override
  State<UpdatePaymentCompanyWidget> createState() =>
      _UpdatePaymentCompanyWidgetState();
}

class _UpdatePaymentCompanyWidgetState
    extends State<UpdatePaymentCompanyWidget> {
  late UpdatePaymentCompanyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdatePaymentCompanyModel());
