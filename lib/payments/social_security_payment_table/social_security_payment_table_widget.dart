...
import 'social_security_payment_table_model.dart';
export 'social_security_payment_table_model.dart';

class SocialSecurityPaymentTableWidget extends StatefulWidget {
  const SocialSecurityPaymentTableWidget({
    super.key,
  ...
  static String routeName = 'socialSecurityPaymentTable';
  static String routePath = '/socialSecurityPaymentTable';

  @override
  State<SocialSecurityPaymentTableWidget> createState() =>
      _SocialSecurityPaymentTableWidgetState();
}

class _SocialSecurityPaymentTableWidgetState
    extends State<SocialSecurityPaymentTableWidget> {
  late SocialSecurityPaymentTableModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SocialSecurityPaymentTableModel());
