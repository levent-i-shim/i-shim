...
import 'tax_payment_table_model.dart';
export 'tax_payment_table_model.dart';

class TaxPaymentTableWidget extends StatefulWidget {
  const TaxPaymentTableWidget({
    super.key,
  ...
  static String routeName = 'taxPaymentTable';
  static String routePath = '/taxPaymentTable';

  @override
  State<TaxPaymentTableWidget> createState() => _TaxPaymentTableWidgetState();
}

class _TaxPaymentTableWidgetState extends State<TaxPaymentTableWidget> {
  late TaxPaymentTableModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TaxPaymentTableModel());
