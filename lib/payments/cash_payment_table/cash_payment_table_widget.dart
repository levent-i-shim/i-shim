...
class CashPaymentTableWidget extends StatefulWidget {
  const CashPaymentTableWidget({
    super.key,
  ...
  static String routeName = 'cashPaymentTable';
  static String routePath = '/cashPaymentTable';

  @override
  State<CashPaymentTableWidget> createState() => _CashPaymentTableWidgetState();
}

class _CashPaymentTableWidgetState extends State<CashPaymentTableWidget> {
  late CashPaymentTableModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CashPaymentTableModel());
