...
import 'art_culture_model.dart';
export 'art_culture_model.dart';

class ArtCultureWidget extends StatefulWidget {
  const ArtCultureWidget({super.key});

  static String routeName = 'artCulture';
  static String routePath = '/artCulture';

  @override
  State<ArtCultureWidget> createState() => _ArtCultureWidgetState();
}

class _ArtCultureWidgetState extends State<ArtCultureWidget> {
  late ArtCultureModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ArtCultureModel());
