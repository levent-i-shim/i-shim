...
class BusinessChooseMainTitlesWidget extends StatefulWidget {
  const BusinessChooseMainTitlesWidget({
    super.key,
  ...
  static String routeName = 'businessChooseMainTitles';
  static String routePath = '/businessChooseMainTitles';

  @override
  State<BusinessChooseMainTitlesWidget> createState() =>
      _BusinessChooseMainTitlesWidgetState();
}

class _BusinessChooseMainTitlesWidgetState
    extends State<BusinessChooseMainTitlesWidget> {
  late BusinessChooseMainTitlesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BusinessChooseMainTitlesModel());
                    ...
                    children: [
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            gradient: LinearGradient(
                              colors: [Color(0xFF120025), Color(0xFF43008A)],
                              stops: [0.0, 1.0],
