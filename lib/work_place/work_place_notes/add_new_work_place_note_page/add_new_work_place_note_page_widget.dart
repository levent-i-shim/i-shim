...
class AddNewWorkPlaceNotePageWidget extends StatefulWidget {
  const AddNewWorkPlaceNotePageWidget({
    super.key,
    required this.workPlace,
    required this.hasVehicleFault,
    required this.hasMachineFault,
    required this.hasFinancialNotes,
    required this.hasTaxNotes,
    required this.hasPersonnelNotes,
    required this.hasWorkplaceNotes,
  });

  final DocumentReference? workPlace;
  final bool? hasVehicleFault;
  final bool? hasMachineFault;
  final bool? hasFinancialNotes;
  final bool? hasTaxNotes;
  final bool? hasPersonnelNotes;
  final bool? hasWorkplaceNotes;

  static String routeName = 'AddNewWorkPlaceNotePage';
  static String routePath = '/addNewWorkPlaceNotePage';

  @override
  State<AddNewWorkPlaceNotePageWidget> createState() =>
      _AddNewWorkPlaceNotePageWidgetState();
}

class _AddNewWorkPlaceNotePageWidgetState
    extends State<AddNewWorkPlaceNotePageWidget> {
  late AddNewWorkPlaceNotePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddNewWorkPlaceNotePageModel());
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    ...
                    if (_model.validate!) {
                      ...
                      _model.addedNote =
                          WorkPlaceNotesRecord.getDocumentFromData({
                        ...createWorkPlaceNotesRecordData(
                          title: _model.textFieldTitleTextController.text,
                          content: _model.textFieldContentTextController.text,
                          isDelete: false,
