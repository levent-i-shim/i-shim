...
class AddManualIncomePageWorkPlaceWidget extends StatefulWidget {
  const AddManualIncomePageWorkPlaceWidget({
    super.key,
  ...
  static String routeName = 'AddManualIncomePageWorkPlace';
  static String routePath = '/addManualIncomePageWorkPlace';

  @override
  State<AddManualIncomePageWorkPlaceWidget> createState() =>
      _AddManualIncomePageWorkPlaceWidgetState();
}

class _AddManualIncomePageWorkPlaceWidgetState
    extends State<AddManualIncomePageWorkPlaceWidget> {
  late AddManualIncomePageWorkPlaceModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddManualIncomePageWorkPlaceModel());
