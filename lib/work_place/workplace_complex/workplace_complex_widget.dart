...
class WorkplaceComplexWidget extends StatefulWidget {
  const WorkplaceComplexWidget({
    super.key,
  ...
  static String routeName = 'WorkplaceComplex';
  static String routePath = '/workplaceComplex';

  @override
  State<WorkplaceComplexWidget> createState() => _WorkplaceComplexWidgetState();
}

class _WorkplaceComplexWidgetState extends State<WorkplaceComplexWidget> {
  late WorkplaceComplexModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WorkplaceComplexModel());
