...
class ShowMyTransactionPageWorkPlaceWidget extends StatefulWidget {
  const ShowMyTransactionPageWorkPlaceWidget({
    super.key,
  ...
  static String routeName = 'ShowMyTransactionPageWorkPlace';
  static String routePath = '/showMyTransactionPageWorkPlace';

  @override
  State<ShowMyTransactionPageWorkPlaceWidget> createState() =>
      _ShowMyTransactionPageWorkPlaceWidgetState();
}

class _ShowMyTransactionPageWorkPlaceWidgetState
    extends State<ShowMyTransactionPageWorkPlaceWidget> {
  late ShowMyTransactionPageWorkPlaceModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ShowMyTransactionPageWorkPlaceModel());
