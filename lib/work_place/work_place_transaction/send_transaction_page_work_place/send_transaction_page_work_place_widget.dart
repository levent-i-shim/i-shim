...
class SendTransactionPageWorkPlaceWidget extends StatefulWidget {
  const SendTransactionPageWorkPlaceWidget({
    super.key,
  ...
  static String routeName = 'SendTransactionPageWorkPlace';
  static String routePath = '/sendTransactionPageWorkPlace';

  @override
  State<SendTransactionPageWorkPlaceWidget> createState() =>
      _SendTransactionPageWorkPlaceWidgetState();
}

class _SendTransactionPageWorkPlaceWidgetState
    extends State<SendTransactionPageWorkPlaceWidget> {
  late SendTransactionPageWorkPlaceModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SendTransactionPageWorkPlaceModel());
    ...
    return StreamBuilder<List<CompanyWorkersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CompanyWorkersRecord>
            sendTransactionPageWorkPlaceCompanyWorkersRecordList =
            snapshot.data!;
                                                                ...
                                                                child: Padding(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                          Text(
                                                                        containerFormResponsesRecord.fieldValueType ==
                                                                                FieldValueType.DateTime.name
                                                                            ? ((String yourDate) {
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            ...
                            _model.transaction2 =
                                WorkPlaceTransactionRecord.getDocumentFromData({
                              ...createWorkPlaceTransactionRecordData(
                                name: _model.textController1.text,
                                description: _model.textController2.text,
                                companyReports:
                            ...
                            await AjandaRecord.createDoc(currentUserReference!)
                              ...
                              ...createAjandaRecordData(
                                ...
                                fullDescription:
                                    '${_model.textController1.text} isimli işlem onaya gönderildi',
                              ),
                              ...mapToFirestore(
                                {
