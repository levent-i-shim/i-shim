...
class AddUnitPageWorkPlaceWidget extends StatefulWidget {
  const AddUnitPageWorkPlaceWidget({
    super.key,
  ...
  static String routeName = 'AddUnitPageWorkPlace';
  static String routePath = '/addUnitPageWorkPlace';

  @override
  State<AddUnitPageWorkPlaceWidget> createState() =>
      _AddUnitPageWorkPlaceWidgetState();
}

class _AddUnitPageWorkPlaceWidgetState
    extends State<AddUnitPageWorkPlaceWidget> {
  late AddUnitPageWorkPlaceModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddUnitPageWorkPlaceModel());
    ...
    return StreamBuilder<List<CompanyDepartmentsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CompanyDepartmentsRecord>
            addUnitPageWorkPlaceCompanyDepartmentsRecordList = snapshot.data!;
                    ...
                    child: Column(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text(
                            'Birim özelliği sayesinde çalışanlarınızı alt gruplara ayırarak ekip yapınızı daha düzenli hale getirebilirsiniz',
                                    ...
                                    Flexible(
                                      ...
                                      child: FlutterFlowDropDown<String>(
                                        ...
                                        options: List<String>.from(
                                            addUnitPageWorkPlaceCompanyDepartmentsRecordList
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              if (_model.dropDownDepartmentValue == null) {
                                _model.validate = false;
                              }
                              ...
                              if (_model.validate!) {
                                ...
                                await workPlaceUnitsRecordReference
                                  ...
                                  isDelete: false,
                                  departmentRef: _model.depRef,
                                  createdBy: currentUserReference,
                                ));
                                _model.ref =
                                    WorkPlaceUnitsRecord.getDocumentFromData(
                                        createWorkPlaceUnitsRecordData(
                                          name: _model.textController.text,
                                          isDelete: false,
                                          departmentRef: _model.depRef,
                                          createdBy: currentUserReference,
                                        ),
                                        workPlaceUnitsRecordReference);
                                _shouldSetState = true;
                                ...
                                _model.companyUnit =
                                    CompanyUnitsRecord.getDocumentFromData(
                                ...
                                await AjandaRecord.createDoc(
                                  ...
                                  ...createAjandaRecordData(
                                    ...
                                    type: WorkHistoryTypes.createUnit.name,
                                    companyUnit: _model.companyUnit?.reference,
                                    fullDescription:
                                        '${_model.companyUnit?.name} isimli Birim Oluşturuldu',
                                  ),
                                  ...mapToFirestore(
                                    {
