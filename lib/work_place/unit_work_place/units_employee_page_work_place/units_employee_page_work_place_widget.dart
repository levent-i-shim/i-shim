...
class UnitsEmployeePageWorkPlaceWidget extends StatefulWidget {
  const UnitsEmployeePageWorkPlaceWidget({
    super.key,
  ...
  final CompanyUnitsRecord? unitRefs;
  ...
  static String routeName = 'UnitsEmployeePageWorkPlace';
  static String routePath = '/unitsEmployeePageWorkPlace';

  @override
  State<UnitsEmployeePageWorkPlaceWidget> createState() =>
      _UnitsEmployeePageWorkPlaceWidgetState();
}

class _UnitsEmployeePageWorkPlaceWidgetState
    extends State<UnitsEmployeePageWorkPlaceWidget> {
  late UnitsEmployeePageWorkPlaceModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UnitsEmployeePageWorkPlaceModel());
                            ...
                            child: Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  context.pushNamed(
                                    EmployeeDetailPageWorkPlaceWidget.routeName,
                                    queryParameters: {
