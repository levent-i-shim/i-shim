...
class MoneyTransferPageWorkPlaceWidget extends StatefulWidget {
  const MoneyTransferPageWorkPlaceWidget({
    super.key,
  ...
  static String routeName = 'MoneyTransferPageWorkPlace';
  static String routePath = '/moneyTransferPageWorkPlace';

  @override
  State<MoneyTransferPageWorkPlaceWidget> createState() =>
      _MoneyTransferPageWorkPlaceWidgetState();
}

class _MoneyTransferPageWorkPlaceWidgetState
    extends State<MoneyTransferPageWorkPlaceWidget> {
  late MoneyTransferPageWorkPlaceModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MoneyTransferPageWorkPlaceModel());
                                            ...
                                            onPressed: () async {
                                              ...
                                              if (selectedFiles != null) {
                                                ...
                                                try {
                                                  ...
                                                  _model.isDataUploading_uploadData3tg =
                                                      false;
                                                }
                                                if (selectedUploadedFiles
                                                    ...
                                                    downloadUrls.length ==
                                                        selectedFiles.length) {
                                                  safeSetState(() {
                                                    _model.uploadedLocalFile_uploadData3tg =
                                                        selectedUploadedFiles
                                                            .first;
                                                    _model.uploadedFileUrl_uploadData3tg =
                                                        downloadUrls.first;
                                                  });
                                                } else {
                                                  safeSetState(() {});
                                            ...
                                            onPressed: () async {
                                              ...
                                              if (selectedMedia != null &&
                                                ...
                                                try {
                                                  ...
                                                  _model.isDataUploading_uploadDataJeo =
                                                      false;
                                                }
                                                if (selectedUploadedFiles
                                                            .length ==
                                                    ...
                                                    downloadUrls.length ==
                                                        selectedMedia.length) {
                                                  safeSetState(() {
                                                    _model.uploadedLocalFile_uploadDataJeo =
                                                        selectedUploadedFiles
                                                            .first;
                                                    _model.uploadedFileUrl_uploadDataJeo =
                                                        downloadUrls.first;
                                                  });
                                                } else {
                                                  safeSetState(() {});
                                        ...
                                        if (_model.isUploadPdf) {
                                          ...
                                          await spentMonetForAllowenceWorkPlaceRecordReference1
                                            ...
                                            ...createSpentMonetForAllowenceWorkPlaceRecordData(
                                              ...
                                              imageUrl: _model
                                                  .uploadedFileUrl_uploadDataJeo,
                                              pdfUrl: _model
                                                  .uploadedFileUrl_uploadData3tg,
                                              senderName:
                  ...
                  if (_model.isUploadPdf)
                    Padding(
                      ...
                      child: FlutterFlowPdfViewer(
                        networkPath: _model.uploadedFileUrl_uploadData3tg,
                        height: 300.0,
