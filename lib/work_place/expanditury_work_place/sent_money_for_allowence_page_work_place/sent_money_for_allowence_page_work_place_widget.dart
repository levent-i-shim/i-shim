...
import 'sent_money_for_allowence_page_work_place_model.dart';
export 'sent_money_for_allowence_page_work_place_model.dart';

class SentMoneyForAllowencePageWorkPlaceWidget extends StatefulWidget {
  const SentMoneyForAllowencePageWorkPlaceWidget({
    super.key,
    required this.company,
    required this.workPlace,
    required this.receiver,
    required this.receiverCompanyWorker,
  });

  final DocumentReference? company;
  final DocumentReference? workPlace;
  final DocumentReference? receiver;
  final DocumentReference? receiverCompanyWorker;

  static String routeName = 'sentMoneyForAllowencePageWorkPlace';
  static String routePath = '/sentMoneyForAllowencePageWorkPlace';

  @override
  State<SentMoneyForAllowencePageWorkPlaceWidget> createState() =>
      _SentMoneyForAllowencePageWorkPlaceWidgetState();
}

class _SentMoneyForAllowencePageWorkPlaceWidgetState
    extends State<SentMoneyForAllowencePageWorkPlaceWidget> {
  late SentMoneyForAllowencePageWorkPlaceModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => SentMoneyForAllowencePageWorkPlaceModel());
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      if (selectedFiles != null) {
                                        safeSetState(() => _model
                                                .isDataUploading_uploadDataHqczx =
                                            true);
                                        ...
                                        try {
                                          ...
                                          _model.isDataUploading_uploadDataHqczx =
                                              false;
                                        }
                                        if (selectedUploadedFiles.length ==
                                            selectedFiles.length) {
                                          safeSetState(() {
                                            _model.uploadedLocalFile_uploadDataHqczx =
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            ...
                            if (_model.isUploadPdf) {
                              {
                                safeSetState(() => _model
                                    .isDataUploading_uploadDataRek = true);
                                var selectedUploadedFiles = <FFUploadedFile>[];
                                var selectedFiles = <SelectedFile>[];
                                var downloadUrls = <String>[];
                                try {
                                  selectedUploadedFiles = _model
                                          .uploadedLocalFile_uploadDataHqczx
                                          .bytes!
                                          .isNotEmpty
                                      ? [
                                          _model
                                  ...
                                  _model.isDataUploading_uploadDataRek = false;
                                }
                                if (selectedUploadedFiles.length ==
                                        selectedFiles.length &&
                                    downloadUrls.length ==
                                        selectedFiles.length) {
                                  safeSetState(() {
                                    _model.uploadedLocalFile_uploadDataRek =
                                        selectedUploadedFiles.first;
                                    _model.uploadedFileUrl_uploadDataRek =
                                        downloadUrls.first;
                                  });
                                } else {
                                  safeSetState(() {});
                            ...
                            if (_model.copmanyDetailMoney?.owner ==
                              ...
                              if (_model.validate!) {
                                await widget!.receiverCompanyWorker!.update({
                                  ...mapToFirestore(
                                    {
                                ...
                                if (_model.isUploadPdf) {
                                  var sentMoneyForAllowenceWorkPlaceRecordReference1 =
                                      SentMoneyForAllowenceWorkPlaceRecord
                                          .createDoc(widget!.workPlace!);
                                  await sentMoneyForAllowenceWorkPlaceRecordReference1
                                      .set({
                                  ...
                                  }, sentMoneyForAllowenceWorkPlaceRecordReference1);
                                  ...
                                  await AjandaRecord.createDoc(
                                    ...
                                    ...createAjandaRecordData(
                                      ...
                                      type:
                                          WorkHistoryTypes.sentExpanditury.name,
                                      sentMoneyForAllowence:
                                          _model.sent1?.reference,
                                      fullDescription:
                                          '${_model.sent1?.sentMoney?.toString()} TL Gönderildi',
                                    ),
                                    ...mapToFirestore(
                                      {
                                        'dateTime':
                                  ...
                                  var sentMoneyForAllowenceWorkPlaceRecordReference2 =
                                      SentMoneyForAllowenceWorkPlaceRecord
                                          .createDoc(widget!.workPlace!);
                                  await sentMoneyForAllowenceWorkPlaceRecordReference2
                                      .set({
                                    ...createSentMoneyForAllowenceWorkPlaceRecordData(
                                      sender: currentUserReference,
                                      receiver: widget!.receiver,
                                  ...
                                  }, sentMoneyForAllowenceWorkPlaceRecordReference2);
                                  ...
                                  await sentMoneyForAllowenceRecordReference2
                                    ...
                                    ...createSentMoneyForAllowenceRecordData(
                                      ...
                                      senderName: currentUserDisplayName,
                                      sentMoneyWorkPlace:
                                          _model.sent2WorkPlace?.reference,
                                    ),
                                    ...mapToFirestore(
                                      {
                                        'date': FieldValue.serverTimestamp(),
                              ...
                              if (_model.companyWorkerAuthUserMoney!
                                ...
                                if (_model.formKey.currentState == null ||
                                    !_model.formKey.currentState!.validate()) {
                                  safeSetState(() => _model.validate1 = false);
                                  return;
                                }
                                if (_model.validate1!) {
                                  await widget!.receiverCompanyWorker!.update({
                                  ...
                                  if (_model.isUploadPdf) {
                                    ...
                                    var spentMoneyForAllowenceRecordReference1 =
                                        SpentMoneyForAllowenceRecord.createDoc(
                                            widget!.company!);
                                    ...
                                    _model.spend3 = SpentMoneyForAllowenceRecord
                                        .getDocumentFromData({
                                      ...createSpentMoneyForAllowenceRecordData(
                                        sender: currentUserReference,
                                        receiver: widget!.receiver,
                                    ...
                                    _model.spend4 = SpentMoneyForAllowenceRecord
                                        .getDocumentFromData({
                                      ...createSpentMoneyForAllowenceRecordData(
                                        sender: currentUserReference,
                                        receiver: widget!.receiver,
