...
import 'spend_money_work_place_page_model.dart';
export 'spend_money_work_place_page_model.dart';

class SpendMoneyWorkPlacePageWidget extends StatefulWidget {
  const SpendMoneyWorkPlacePageWidget({
    super.key,
  ...
  static String routeName = 'SpendMoneyWorkPlacePage';
  static String routePath = '/spendMoneyWorkPlacePage';

  @override
  State<SpendMoneyWorkPlacePageWidget> createState() =>
      _SpendMoneyWorkPlacePageWidgetState();
}

class _SpendMoneyWorkPlacePageWidgetState
    extends State<SpendMoneyWorkPlacePageWidget> {
  late SpendMoneyWorkPlacePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SpendMoneyWorkPlacePageModel());
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          ...
                                          if (selectedFiles != null) {
                                            safeSetState(() => _model
                                                    .isDataUploading_uploadData3tgzy =
                                                true);
                                            ...
                                            try {
                                              ...
                                              _model.isDataUploading_uploadData3tgzy =
                                                  false;
                                            }
                                            if (selectedUploadedFiles.length ==
                                                ...
                                                downloadUrls.length ==
                                                    selectedFiles.length) {
                                              safeSetState(() {
                                                _model.uploadedLocalFile_uploadData3tgzy =
                                                    selectedUploadedFiles.first;
                                                _model.uploadedFileUrl_uploadData3tgzy =
                                                    downloadUrls.first;
                                              });
                                            } else {
                                              safeSetState(() {});
                                          ...
                                          if (selectedMedia != null &&
                                              selectedMedia.every((m) =>
                                                  validateFileFormat(
                                                      ...
                                                      context))) {
                                            safeSetState(() => _model
                                                    .isDataUploading_uploadDataJeozy =
                                                true);
                                            var selectedUploadedFiles =
                                                <FFUploadedFile>[];
                                            ...
                                            try {
                                              ...
                                              _model.isDataUploading_uploadDataJeozy =
                                                  false;
                                            }
                                            if (selectedUploadedFiles.length ==
                                                ...
                                                downloadUrls.length ==
                                                    selectedMedia.length) {
                                              safeSetState(() {
                                                _model.uploadedLocalFile_uploadDataJeozy =
                                                    selectedUploadedFiles.first;
                                                _model.uploadedFileUrl_uploadDataJeozy =
                                                    downloadUrls.first;
                                              });
                                            } else {
                                              safeSetState(() {});
                                    ...
                                    if (_model.isUploadPdf) {
                                      ...
                                      await spentMonetForAllowenceWorkPlaceRecordReference1
                                        ...
                                        ...createSpentMonetForAllowenceWorkPlaceRecordData(
                                          ...
                                          imageUrl: _model
                                              .uploadedFileUrl_uploadDataJeozy,
                                          pdfUrl: _model
                                              .uploadedFileUrl_uploadData3tgzy,
                  ...
                  if (_model.isUploadPdf)
                    Padding(
                      ...
                      child: FlutterFlowPdfViewer(
                        networkPath: _model.uploadedFileUrl_uploadData3tgzy,
                        height: 300.0,
