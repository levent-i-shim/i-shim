...
class AddRolePageWorkPlaceWidget extends StatefulWidget {
  const AddRolePageWorkPlaceWidget({
    super.key,
  ...
  static String routeName = 'AddRolePageWorkPlace';
  static String routePath = '/addRolePageWorkPlace';

  @override
  State<AddRolePageWorkPlaceWidget> createState() =>
      _AddRolePageWorkPlaceWidgetState();
}

class _AddRolePageWorkPlaceWidgetState
    extends State<AddRolePageWorkPlaceWidget> {
  late AddRolePageWorkPlaceModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddRolePageWorkPlaceModel());
                              ...
                              if (_model.validate!) {
                                ...
                                await AjandaRecord.createDoc(
                                  ...
                                  ...createAjandaRecordData(
                                    ...
                                    companyRole: _model.companyRole?.reference,
                                    companyName: '        ',
                                    fullDescription:
