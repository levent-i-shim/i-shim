...
class WorkPlaceTaskForDutyCreatePageWidget extends StatefulWidget {
  const WorkPlaceTaskForDutyCreatePageWidget({
    super.key,
  ...
  static String routeName = 'WorkPlaceTaskForDutyCreatePage';
  static String routePath = '/workPlaceTaskForDutyCreatePage';

  @override
  State<WorkPlaceTaskForDutyCreatePageWidget> createState() =>
      _WorkPlaceTaskForDutyCreatePageWidgetState();
}

class _WorkPlaceTaskForDutyCreatePageWidgetState
    extends State<WorkPlaceTaskForDutyCreatePageWidget> {
  late WorkPlaceTaskForDutyCreatePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WorkPlaceTaskForDutyCreatePageModel());
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Builder(
                    builder: (context) {
                      final duty = _model.duties.toList();
                                      ...
                                      child: Padding(
                                        ...
                                        child: FlutterFlowIconButton(
                                          ...
                                          onPressed: () async {
                                            ...
                                            _model.removeFromDuties(dutyItem);
                                            safeSetState(() {});
                                          },
                                        ),
                                      ),
