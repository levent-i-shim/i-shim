...
class WorkPlaceControlOperationsPageForPartnerWidget extends StatefulWidget {
  const WorkPlaceControlOperationsPageForPartnerWidget({
    super.key,
  ...
  static String routeName = 'WorkPlaceControlOperationsPageForPartner';
  static String routePath = '/workPlaceControlOperationsPageForPartner';

  @override
  State<WorkPlaceControlOperationsPageForPartnerWidget> createState() =>
      _WorkPlaceControlOperationsPageForPartnerWidgetState();
}

class _WorkPlaceControlOperationsPageForPartnerWidgetState
    extends State<WorkPlaceControlOperationsPageForPartnerWidget> {
  late WorkPlaceControlOperationsPageForPartnerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(
        context, () => WorkPlaceControlOperationsPageForPartnerModel());
