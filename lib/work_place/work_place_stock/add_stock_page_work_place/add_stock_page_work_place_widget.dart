...
class AddStockPageWorkPlaceWidget extends StatefulWidget {
  const AddStockPageWorkPlaceWidget({
    super.key,
  ...
  static String routeName = 'AddStockPageWorkPlace';
  static String routePath = '/addStockPageWorkPlace';

  @override
  State<AddStockPageWorkPlaceWidget> createState() =>
      _AddStockPageWorkPlaceWidgetState();
}

class _AddStockPageWorkPlaceWidgetState
    extends State<AddStockPageWorkPlaceWidget> {
  late AddStockPageWorkPlaceModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddStockPageWorkPlaceModel());
                                ...
                                onPressed: () async {
                                  ...
                                  if (_model.validate!) {
                                    ...
                                    _model.stockWorkPlace =
                                      ...
                                      ...mapToFirestore(
                                        {
                                          'stockAdditionTime': DateTime.now(),
                                        },
                                      ),
                                    ...
                                    await AjandaRecord.createDoc(
                                      ...
                                      ...createAjandaRecordData(
                                        ...
                                        type: WorkHistoryTypes.createStock.name,
                                        fullDescription:
