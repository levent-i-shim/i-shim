...
class WorkPlaceVehiclePaymentsWidget extends StatefulWidget {
  const WorkPlaceVehiclePaymentsWidget({
    super.key,
  ...
  static String routeName = 'WorkPlaceVehiclePayments';
  static String routePath = '/workPlaceVehiclePayments';

  @override
  State<WorkPlaceVehiclePaymentsWidget> createState() =>
      _WorkPlaceVehiclePaymentsWidgetState();
}

class _WorkPlaceVehiclePaymentsWidgetState
    extends State<WorkPlaceVehiclePaymentsWidget> {
  late WorkPlaceVehiclePaymentsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WorkPlaceVehiclePaymentsModel());
                    ...
                    child: PagedListView<DocumentSnapshot<Object?>?,
                      ...
                      builderDelegate: PagedChildBuilderDelegate<
                        ...
                        itemBuilder: (context, _, listViewIndex) {
                          final listViewCompanyVehiclePaymentsRecord = _model
                                            ...
                                            child: Padding(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    listViewCompanyVehiclePaymentsRecord
                                                        .type,
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyMedium
