...
import '/index.dart';
import 'work_place_vehicles_page_widget.dart' show WorkPlaceVehiclesPageWidget;
import 'package:flutter/material.dart';
import 'package:infinite_scroll_pagination/infinite_scroll_pagination.dart';

class WorkPlaceVehiclesPageModel
    extends FlutterFlowModel<WorkPlaceVehiclesPageWidget> {
  ///  State fields for stateful widgets in this page.

  // State field(s) for ListView widget.

  PagingController<DocumentSnapshot?, CompanyVehiclesRecord>?
  ...
  PagingController<DocumentSnapshot?, CompanyVehiclesRecord>
    ...
    return controller
      ..addPageRequestListener(
        (nextPageMarker) => queryCompanyVehiclesRecordPage(
          parent: parent,
