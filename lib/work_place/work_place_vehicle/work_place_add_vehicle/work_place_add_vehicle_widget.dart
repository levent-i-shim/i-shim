...
class WorkPlaceAddVehicleWidget extends StatefulWidget {
  const WorkPlaceAddVehicleWidget({
    super.key,
  ...
  static String routeName = 'WorkPlaceAddVehicle';
  static String routePath = '/workPlaceAddVehicle';

  @override
  State<WorkPlaceAddVehicleWidget> createState() =>
      _WorkPlaceAddVehicleWidgetState();
}

class _WorkPlaceAddVehicleWidgetState extends State<WorkPlaceAddVehicleWidget> {
  late WorkPlaceAddVehicleModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WorkPlaceAddVehicleModel());
                                ...
                                child: FlutterFlowDropDown<String>(
                                  ...
                                  onChanged: (val) async {
                                    ...
                                    _model.isSelectedConstruction =
                                        _model.dropDownValue == 'construction'
                                            ? true
                                            : false;
                                    _model.isSelectedTruck =
                                        _model.dropDownValue == 'truck'
                                            ? true
                                            : false;
                                    safeSetState(() {});
                                  },
                        ...
                        if (_model.validate!) {
                          ...
                          await workPlaceVehicleRecordReference.set({
                            ...createWorkPlaceVehicleRecordData(
                              ...
                              model: _model.textController4.text,
                              year: _model.textController7.text,
