...
class WorkPlaceControlOperationsPageWidget extends StatefulWidget {
  const WorkPlaceControlOperationsPageWidget({
    super.key,
  ...
  static String routeName = 'WorkPlaceControlOperationsPage';
  static String routePath = '/workPlaceControlOperationsPage';

  @override
  State<WorkPlaceControlOperationsPageWidget> createState() =>
      _WorkPlaceControlOperationsPageWidgetState();
}

class _WorkPlaceControlOperationsPageWidgetState
    extends State<WorkPlaceControlOperationsPageWidget> {
  late WorkPlaceControlOperationsPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WorkPlaceControlOperationsPageModel());
