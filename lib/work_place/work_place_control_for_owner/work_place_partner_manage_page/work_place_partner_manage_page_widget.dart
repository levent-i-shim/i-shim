...
import 'work_place_partner_manage_page_model.dart';
export 'work_place_partner_manage_page_model.dart';

class WorkPlacePartnerManagePageWidget extends StatefulWidget {
  const WorkPlacePartnerManagePageWidget({
    super.key,
    required this.partnership,
    this.workPlacePartnerRef,
    this.workPlaceRef,
  });

  final WorkPlacePartnershipRecord? partnership;
  final DocumentReference? workPlacePartnerRef;
  final DocumentReference? workPlaceRef;

  static String routeName = 'WorkPlacePartnerManagePage';
  static String routePath = '/workPlacePartnerManagePage';

  @override
  State<WorkPlacePartnerManagePageWidget> createState() =>
      _WorkPlacePartnerManagePageWidgetState();
}

class _WorkPlacePartnerManagePageWidgetState
    extends State<WorkPlacePartnerManagePageWidget> {
  late WorkPlacePartnerManagePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WorkPlacePartnerManagePageModel());

    _model.switchCanViewExpenseValue =
        widget!.partnership!.canViewIncomeExpense;
    _model.switchCanAddManuelExpenseIncomeValue =
        widget!.partnership!.canManageWorkers;
    _model.switchCanManageTransactionValue =
        widget!.partnership!.canManagePendingIncomeExpense;
    _model.switchCanViewExpandituryValue =
        widget!.partnership!.canViewEmployeeExpense;
    _model.switcCanSpendMoneyValue =
        widget!.partnership!.canManageEmployeeExpense;
    ...
    _model.switchCanCreateTaskValue = widget!.partnership!.canCreateTask;
    _model.switchCanManageTaskValue = widget!.partnership!.canManageTask;
    ...
    _model.switchCanCreateInstructionsValue =
        widget!.partnership!.canManageInstructions;
    ...
    _model.switchCanViewUserValue = widget!.partnership!.canManageWorkers;
    _model.switchCanCalculateCostValue = widget!.partnership!.canManageWorkers;
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Switch.adaptive(
                            value: _model.switchCanAddManuelExpenseIncomeValue!,
                            onChanged: (newValue) async {
                              safeSetState(() =>
                                  _model.switchCanAddManuelExpenseIncomeValue =
                                      newValue!);
                      ...
                      Row(
                        ...
                        children: [
                          Expanded(
                            flex: 8,
                            child: Text(
                              'Onay Bekleyen Gelir/Giderlerde İşlem Yapabilme',
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                                    font: GoogleFonts.inter(
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Switch.adaptive(
                            value: _model.switchCanCreateTaskValue!,
                            onChanged: (newValue) async {
                              safeSetState(() =>
                                  _model.switchCanCreateTaskValue = newValue!);
                            },
                            activeColor: FlutterFlowTheme.of(context).primary,
                            activeTrackColor:
                                FlutterFlowTheme.of(context).primary,
                      ...
                      Row(
                        ...
                        children: [
                          Text(
                            'Departmanlarda işlem Yapabilme',
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                                  font: GoogleFonts.inter(
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Switch.adaptive(
                            value: _model.switchCanCreateInstructionsValue!,
                            onChanged: (newValue) async {
                              safeSetState(() =>
                                  _model.switchCanCreateInstructionsValue =
                                      newValue!);
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Switch.adaptive(
                            value: _model.switchCanViewUserValue!,
                            onChanged: (newValue) async {
                              safeSetState(() =>
                                  _model.switchCanViewUserValue = newValue!);
                            },
                            activeColor: FlutterFlowTheme.of(context).primary,
                            activeTrackColor:
                                FlutterFlowTheme.of(context).primary,
                      ...
                      Row(
                        ...
                        children: [
                          Flexible(
                            flex: 8,
                            child: Text(
                              'Maliyet Hesaplayabilme Yetkisi',
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                                    font: GoogleFonts.inter(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            await widget!.partnership!.reference
                                .update(createWorkPlacePartnershipRecordData(
                              canViewTasks: _model.switchCanViewTaskValue,
                              canViewStock: _model.switchCanViewStockValue,
                              canViewForms: _model.switchCanViewFormsValue,
                              canManageStock: _model.switchCanManageStockValue,
                              canManageForms: _model.switchCanManageFormsValue,
                              canManageRoles: _model.switchCanManageRolesValue,
                              canManageUnits: _model.switchCanManageUnitsValue,
                              canViewVehicles:
                                  _model.switchCanViewVehiclesValue,
                              canManageWorkers:
                                  _model.switchCanManageUsersValue,
                              canManageVehicles:
                                  _model.switchCanManageVehiclesValue,
                              ...
                              canManageEmployeeExpense:
                                  _model.switcCanSpendMoneyValue,
                              canCreateTask: _model.switchCanCreateTaskValue,
                              canManageTask: _model.switchCanManageTaskValue,
                              ...
                              canAddManuelExpenseIncome:
                                  _model.switchCanAddManuelExpenseIncomeValue,
                              canViewEmployee: _model.switchCanViewUserValue,
                              canCalculateCost:
