...
import 'employee_permissions_page_work_place_model.dart';
export 'employee_permissions_page_work_place_model.dart';

class EmployeePermissionsPageWorkPlaceWidget extends StatefulWidget {
  const EmployeePermissionsPageWorkPlaceWidget({
    super.key,
  ...
  static String routeName = 'EmployeePermissionsPageWorkPlace';
  static String routePath = '/employeePermissionsPageWorkPlace';

  @override
  State<EmployeePermissionsPageWorkPlaceWidget> createState() =>
      _EmployeePermissionsPageWorkPlaceWidgetState();
}

class _EmployeePermissionsPageWorkPlaceWidgetState
    extends State<EmployeePermissionsPageWorkPlaceWidget> {
  late EmployeePermissionsPageWorkPlaceModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => EmployeePermissionsPageWorkPlaceModel());
    ...
    _model.switchSendMoneyValue = widget!.companyWorker!.canSendMoney;
    ...
    _model.switchCanViewEmployeeValue = widget!.companyWorker!.canViewEmployee;
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: Color(0xFF0D0124),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Flexible(
                          flex: 2,
                          child: Switch.adaptive(
                            value: _model.switchCanViewEmployeeValue!,
                            onChanged: (newValue) async {
                              safeSetState(() => _model
                                  .switchCanViewEmployeeValue = newValue!);
                            },
                            activeColor: FlutterFlowTheme.of(context).primary,
                            activeTrackColor:
                                FlutterFlowTheme.of(context).primary,
                    ...
                    Row(
                      ...
                      children: [
                        Flexible(
                          flex: 7,
                          child: Text(
                            'Notlarda işlem yapabilme Yetkisi',
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                                  font: GoogleFonts.inter(
                        ...
                        onPressed: () async {
                          ...
                          await widget!.companyWorker!.reference
                            ...
                            canViewIncomeExpense:
                                _model.switchCanViewIncomeExpenseValue,
                            canViewEmployee: _model.switchCanViewEmployeeValue,
                          ...
                          if (_model.switchExpandituryValue == true) {
