...
class EditEmployeeDetailPageWorkPlaceWidget extends StatefulWidget {
  const EditEmployeeDetailPageWorkPlaceWidget({
    super.key,
  ...
  static String routeName = 'EditEmployeeDetailPageWorkPlace';
  static String routePath = '/editEmployeeDetailPageWorkPlace';

  @override
  State<EditEmployeeDetailPageWorkPlaceWidget> createState() =>
      _EditEmployeeDetailPageWorkPlaceWidgetState();
}

class _EditEmployeeDetailPageWorkPlaceWidgetState
    extends State<EditEmployeeDetailPageWorkPlaceWidget> {
  late EditEmployeeDetailPageWorkPlaceModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditEmployeeDetailPageWorkPlaceModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.companyUnits = _model.units!.toList().cast<CompanyUnitsRecord>();
      safeSetState(() {});
    });
                              ...
                              StreamBuilder<List<CompanyDepartmentsRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<CompanyDepartmentsRecord>
                                      dropDownDepartmentCompanyDepartmentsRecordList =
                                      snapshot.data!;
                                  ...
                                  return FlutterFlowDropDown<String>(
                                    ...
                                    onChanged: (val) async {
                                      safeSetState(() =>
                                          _model.dropDownDepartmentValue = val);
                                      _model.dep =
                                      ...
                                      _model.companyUnits = _model.units!
                                          .where((e) =>
                                              e.departmenRef == _model.dep)
                                          .toList()
                                          .cast<CompanyUnitsRecord>();
                                      safeSetState(() {});
                            ...
                            children: [
                              ...
                              FlutterFlowDropDown<String>(
                                ...
                                options: List<String>.from(_model.companyUnits
                                    .map((e) => e.reference.id)
                                    .toList()),
                                optionLabels: _model.companyUnits
                                    .map((e) => e.name)
                                    .toList(),
                              ...
                              StreamBuilder<List<CompanyRolesRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<CompanyRolesRecord>
                                      dropDownRoleCompanyRolesRecordList =
                                      snapshot.data!;
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        await widget.companyWorker!.reference.update({
                          ...
                          ...mapToFirestore(
                            {
                              'unitRefs': _model.newUnitRefs,
                              'departmentRefs': _model.newDepRefs,
                              'roleRefs': _model.newRoleRefs,
