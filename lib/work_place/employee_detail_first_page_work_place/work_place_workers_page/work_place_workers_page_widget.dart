...
class WorkPlaceWorkersPageWidget extends StatefulWidget {
  const WorkPlaceWorkersPageWidget({
    super.key,
  ...
  static String routeName = 'WorkPlaceWorkersPage';
  static String routePath = '/workPlaceWorkersPage';

  @override
  State<WorkPlaceWorkersPageWidget> createState() =>
      _WorkPlaceWorkersPageWidgetState();
}

class _WorkPlaceWorkersPageWidgetState
    extends State<WorkPlaceWorkersPageWidget> {
  late WorkPlaceWorkersPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WorkPlaceWorkersPageModel());
