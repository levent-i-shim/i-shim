...
import 'unit_instructions_page_work_place_model.dart';
export 'unit_instructions_page_work_place_model.dart';

class UnitInstructionsPageWorkPlaceWidget extends StatefulWidget {
  const UnitInstructionsPageWorkPlaceWidget({
    super.key,
  ...
  static String routeName = 'UnitInstructionsPageWorkPlace';
  static String routePath = '/unitInstructionsPageWorkPlace';

  @override
  State<UnitInstructionsPageWorkPlaceWidget> createState() =>
      _UnitInstructionsPageWorkPlaceWidgetState();
}

class _UnitInstructionsPageWorkPlaceWidgetState
    extends State<UnitInstructionsPageWorkPlaceWidget> {
  late UnitInstructionsPageWorkPlaceModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UnitInstructionsPageWorkPlaceModel());
    ...
    return StreamBuilder<List<CompanyUnitsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CompanyUnitsRecord>
            unitInstructionsPageWorkPlaceCompanyUnitsRecordList =
            snapshot.data!;
