...
class RoleInstructionPageWorkPlaceWidget extends StatefulWidget {
  const RoleInstructionPageWorkPlaceWidget({
    super.key,
  ...
  static String routeName = 'RoleInstructionPageWorkPlace';
  static String routePath = '/roleInstructionPageWorkPlace';

  @override
  State<RoleInstructionPageWorkPlaceWidget> createState() =>
      _RoleInstructionPageWorkPlaceWidgetState();
}

class _RoleInstructionPageWorkPlaceWidgetState
    extends State<RoleInstructionPageWorkPlaceWidget> {
  late RoleInstructionPageWorkPlaceModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RoleInstructionPageWorkPlaceModel());
    ...
    return StreamBuilder<List<CompanyRolesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CompanyRolesRecord>
            roleInstructionPageWorkPlaceCompanyRolesRecordList = snapshot.data!;
                        ...
                        children: [
                          ...
                          FlutterFlowDropDown<String>(
                            ...
                            options: List<String>.from(
                                roleInstructionPageWorkPlaceCompanyRolesRecordList
