...
import 'instructions_department_page_work_place_model.dart';
export 'instructions_department_page_work_place_model.dart';

class InstructionsDepartmentPageWorkPlaceWidget extends StatefulWidget {
  const InstructionsDepartmentPageWorkPlaceWidget({
    super.key,
    required this.company,
    required this.workPlace,
    required this.isPartner,
    required this.canSendInstruction,
  ...
  final bool? canSendInstruction;
  final bool? isWorker;

  static String routeName = 'InstructionsDepartmentPageWorkPlace';
  static String routePath = '/instructionsDepartmentPageWorkPlace';

  @override
  State<InstructionsDepartmentPageWorkPlaceWidget> createState() =>
      _InstructionsDepartmentPageWorkPlaceWidgetState();
}

class _InstructionsDepartmentPageWorkPlaceWidgetState
    extends State<InstructionsDepartmentPageWorkPlaceWidget> {
  late InstructionsDepartmentPageWorkPlaceModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => InstructionsDepartmentPageWorkPlaceModel());
    ...
    return StreamBuilder<List<CompanyDepartmentsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CompanyDepartmentsRecord>
            instructionsDepartmentPageWorkPlaceCompanyDepartmentsRecordList =
            snapshot.data!;
                                  ...
                                  for (int loop1Index = 0;
                                    ...
                                    await NotificationsRecord.createDoc(
                                      ...
                                      ...createNotificationsRecordData(
                                        type:
                                            NotificationTypes.instruction.name,
